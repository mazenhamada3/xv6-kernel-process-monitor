...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	42a78793          	addi	a5,a5,1066 # 7438 <malloc+0x249c>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	03a50513          	addi	a0,a0,58 # 50a0 <malloc+0x104>
      6e:	67b040ef          	jal	4ee8 <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	02050513          	addi	a0,a0,32 # 50c0 <malloc+0x124>
      a8:	641040ef          	jal	4ee8 <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	01850513          	addi	a0,a0,24 # 50d8 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	02250513          	addi	a0,a0,34 # 50f8 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	fee50513          	addi	a0,a0,-18 # 50e0 <malloc+0x144>
      fa:	5ef040ef          	jal	4ee8 <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	00250513          	addi	a0,a0,2 # 5108 <malloc+0x16c>
     10e:	5db040ef          	jal	4ee8 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	fb450513          	addi	a0,a0,-76 # 5130 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	faa50513          	addi	a0,a0,-86 # 5150 <malloc+0x1b4>
     1ae:	53b040ef          	jal	4ee8 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	f3450513          	addi	a0,a0,-204 # 5178 <malloc+0x1dc>
     24c:	085040ef          	jal	4ad0 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	f24a8a93          	addi	s5,s5,-220 # 5178 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	ec650513          	addi	a0,a0,-314 # 5188 <malloc+0x1ec>
     2ca:	41f040ef          	jal	4ee8 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	ecc50513          	addi	a0,a0,-308 # 51a8 <malloc+0x20c>
     2e4:	405040ef          	jal	4ee8 <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	ec250513          	addi	a0,a0,-318 # 51c0 <malloc+0x224>
     306:	7ca040ef          	jal	4ad0 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	eb298993          	addi	s3,s3,-334 # 51c0 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	e7650513          	addi	a0,a0,-394 # 51c0 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	dea58593          	addi	a1,a1,-534 # 5148 <malloc+0x1ac>
     366:	73a040ef          	jal	4aa0 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	e7050513          	addi	a0,a0,-400 # 51e0 <malloc+0x244>
     378:	371040ef          	jal	4ee8 <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	702040ef          	jal	4a80 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	e4650513          	addi	a0,a0,-442 # 51c8 <malloc+0x22c>
     38a:	35f040ef          	jal	4ee8 <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	6f0040ef          	jal	4a80 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	e3450513          	addi	a0,a0,-460 # 51c8 <malloc+0x22c>
     39c:	34d040ef          	jal	4ee8 <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	e1450513          	addi	a0,a0,-492 # 51c0 <malloc+0x224>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	fa878793          	addi	a5,a5,-88 # 7438 <malloc+0x249c>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	d32a0a13          	addi	s4,s4,-718 # 51f0 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	cb450513          	addi	a0,a0,-844 # 51f8 <malloc+0x25c>
     54c:	19d040ef          	jal	4ee8 <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	cb650513          	addi	a0,a0,-842 # 5210 <malloc+0x274>
     562:	187040ef          	jal	4ee8 <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	cd050513          	addi	a0,a0,-816 # 5240 <malloc+0x2a4>
     578:	171040ef          	jal	4ee8 <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	502040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	cee50513          	addi	a0,a0,-786 # 5270 <malloc+0x2d4>
     58a:	15f040ef          	jal	4ee8 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	ce850513          	addi	a0,a0,-792 # 5280 <malloc+0x2e4>
     5a0:	149040ef          	jal	4ee8 <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	e7a78793          	addi	a5,a5,-390 # 7438 <malloc+0x249c>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	cbea0a13          	addi	s4,s4,-834 # 52b0 <malloc+0x314>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	b4ea8a93          	addi	s5,s5,-1202 # 5148 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	c3a50513          	addi	a0,a0,-966 # 52b8 <malloc+0x31c>
     686:	063040ef          	jal	4ee8 <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	c3c50513          	addi	a0,a0,-964 # 52d0 <malloc+0x334>
     69c:	04d040ef          	jal	4ee8 <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	3de040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	bca50513          	addi	a0,a0,-1078 # 5270 <malloc+0x2d4>
     6ae:	03b040ef          	jal	4ee8 <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	3cc040ef          	jal	4a80 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	c4850513          	addi	a0,a0,-952 # 5300 <malloc+0x364>
     6c0:	029040ef          	jal	4ee8 <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	c4a50513          	addi	a0,a0,-950 # 5318 <malloc+0x37c>
     6d6:	013040ef          	jal	4ee8 <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	a3c50513          	addi	a0,a0,-1476 # 5130 <malloc+0x194>
     6fc:	3d4040ef          	jal	4ad0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	a2c50513          	addi	a0,a0,-1492 # 5130 <malloc+0x194>
     70c:	3b4040ef          	jal	4ac0 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	a2c58593          	addi	a1,a1,-1492 # 5140 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	a0850513          	addi	a0,a0,-1528 # 5130 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	9e450513          	addi	a0,a0,-1564 # 5130 <malloc+0x194>
     754:	36c040ef          	jal	4ac0 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	9d450513          	addi	a0,a0,-1580 # 5130 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	c1a58593          	addi	a1,a1,-998 # 53a8 <malloc+0x40c>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	96c50513          	addi	a0,a0,-1684 # 5130 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	b5050513          	addi	a0,a0,-1200 # 5348 <malloc+0x3ac>
     800:	6e8040ef          	jal	4ee8 <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	b5c50513          	addi	a0,a0,-1188 # 5368 <malloc+0x3cc>
     814:	6d4040ef          	jal	4ee8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	b5c50513          	addi	a0,a0,-1188 # 5378 <malloc+0x3dc>
     824:	6c4040ef          	jal	4ee8 <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	b6850513          	addi	a0,a0,-1176 # 5398 <malloc+0x3fc>
     838:	6b0040ef          	jal	4ee8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	b3850513          	addi	a0,a0,-1224 # 5378 <malloc+0x3dc>
     848:	6a0040ef          	jal	4ee8 <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	b5a50513          	addi	a0,a0,-1190 # 53b0 <malloc+0x414>
     85e:	68a040ef          	jal	4ee8 <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	b6450513          	addi	a0,a0,-1180 # 53d0 <malloc+0x434>
     874:	674040ef          	jal	4ee8 <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	b5850513          	addi	a0,a0,-1192 # 53f0 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	b6c98993          	addi	s3,s3,-1172 # 5418 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	b9ca8a93          	addi	s5,s5,-1124 # 5450 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	b0250513          	addi	a0,a0,-1278 # 53f0 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     922:	ad250513          	addi	a0,a0,-1326 # 53f0 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	ab450513          	addi	a0,a0,-1356 # 53f8 <malloc+0x45c>
     94c:	59c040ef          	jal	4ee8 <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	ace50513          	addi	a0,a0,-1330 # 5428 <malloc+0x48c>
     962:	586040ef          	jal	4ee8 <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	af050513          	addi	a0,a0,-1296 # 5460 <malloc+0x4c4>
     978:	570040ef          	jal	4ee8 <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	b0450513          	addi	a0,a0,-1276 # 5488 <malloc+0x4ec>
     98c:	55c040ef          	jal	4ee8 <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	b1050513          	addi	a0,a0,-1264 # 54a8 <malloc+0x50c>
     9a0:	548040ef          	jal	4ee8 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	b1450513          	addi	a0,a0,-1260 # 54c0 <malloc+0x524>
     9b4:	534040ef          	jal	4ee8 <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	b0a50513          	addi	a0,a0,-1270 # 54e0 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	ac450513          	addi	a0,a0,-1340 # 54e0 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a8c50513          	addi	a0,a0,-1396 # 54e8 <malloc+0x54c>
     a64:	484040ef          	jal	4ee8 <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	a9650513          	addi	a0,a0,-1386 # 5508 <malloc+0x56c>
     a7a:	46e040ef          	jal	4ee8 <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	aaa50513          	addi	a0,a0,-1366 # 5530 <malloc+0x594>
     a8e:	45a040ef          	jal	4ee8 <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	a3a50513          	addi	a0,a0,-1478 # 54e0 <malloc+0x544>
     ...
     ad0:	a8450513          	addi	a0,a0,-1404 # 5550 <malloc+0x5b4>
     ad4:	414040ef          	jal	4ee8 <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	a9650513          	addi	a0,a0,-1386 # 5578 <malloc+0x5dc>
     aea:	3fe040ef          	jal	4ee8 <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	a9850513          	addi	a0,a0,-1384 # 5590 <malloc+0x5f4>
     b00:	3e8040ef          	jal	4ee8 <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	aac50513          	addi	a0,a0,-1364 # 55b8 <malloc+0x61c>
     b14:	3d4040ef          	jal	4ee8 <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	a9e50513          	addi	a0,a0,-1378 # 55d0 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	aba58593          	addi	a1,a1,-1350 # 5600 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	a7650513          	addi	a0,a0,-1418 # 55d0 <malloc+0x634>
  ...
  unlink("unlinkread");
     ...
     be6:	9ee50513          	addi	a0,a0,-1554 # 55d0 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	9e250513          	addi	a0,a0,-1566 # 55e0 <malloc+0x644>
     c06:	2e2040ef          	jal	4ee8 <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	9f650513          	addi	a0,a0,-1546 # 5608 <malloc+0x66c>
     c1a:	2ce040ef          	jal	4ee8 <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	a0250513          	addi	a0,a0,-1534 # 5628 <malloc+0x68c>
     c2e:	2ba040ef          	jal	4ee8 <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	a1650513          	addi	a0,a0,-1514 # 5650 <malloc+0x6b4>
     c42:	2a6040ef          	jal	4ee8 <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	a2250513          	addi	a0,a0,-1502 # 5670 <malloc+0x6d4>
     c56:	292040ef          	jal	4ee8 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	a2e50513          	addi	a0,a0,-1490 # 5690 <malloc+0x6f4>
     c6a:	27e040ef          	jal	4ee8 <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	a2e50513          	addi	a0,a0,-1490 # 56b0 <malloc+0x714>
     c8a:	647030ef          	jal	4ad0 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	a2a50513          	addi	a0,a0,-1494 # 56b8 <malloc+0x71c>
     c96:	63b030ef          	jal	4ad0 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	a1250513          	addi	a0,a0,-1518 # 56b0 <malloc+0x714>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	94e58593          	addi	a1,a1,-1714 # 5600 <malloc+0x664>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	93650513          	addi	a0,a0,-1738 # 56c0 <malloc+0x724>
     d92:	156040ef          	jal	4ee8 <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	93a50513          	addi	a0,a0,-1734 # 56d8 <malloc+0x73c>
     da6:	142040ef          	jal	4ee8 <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	93e50513          	addi	a0,a0,-1730 # 56f0 <malloc+0x754>
     dba:	12e040ef          	jal	4ee8 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	94a50513          	addi	a0,a0,-1718 # 5710 <malloc+0x774>
     dce:	11a040ef          	jal	4ee8 <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	96650513          	addi	a0,a0,-1690 # 5740 <malloc+0x7a4>
     de2:	106040ef          	jal	4ee8 <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	96a50513          	addi	a0,a0,-1686 # 5758 <malloc+0x7bc>
     df6:	0f2040ef          	jal	4ee8 <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	96e50513          	addi	a0,a0,-1682 # 5770 <malloc+0x7d4>
     e0a:	0de040ef          	jal	4ee8 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	98250513          	addi	a0,a0,-1662 # 5798 <malloc+0x7fc>
     e1e:	0ca040ef          	jal	4ee8 <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	99e50513          	addi	a0,a0,-1634 # 57c8 <malloc+0x82c>
     e32:	0b6040ef          	jal	4ee8 <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	99498993          	addi	s3,s3,-1644 # 57e8 <malloc+0x84c>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	96c50513          	addi	a0,a0,-1684 # 57f8 <malloc+0x85c>
     e94:	054040ef          	jal	4ee8 <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	96450513          	addi	a0,a0,-1692 # 5818 <malloc+0x87c>
     ebc:	415030ef          	jal	4ad0 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	95450513          	addi	a0,a0,-1708 # 5818 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	93aa0a13          	addi	s4,s4,-1734 # 5818 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	8ec50513          	addi	a0,a0,-1812 # 5818 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	88c50513          	addi	a0,a0,-1908 # 5820 <malloc+0x884>
     f9c:	74d030ef          	jal	4ee8 <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	89250513          	addi	a0,a0,-1902 # 5840 <malloc+0x8a4>
     fb6:	733030ef          	jal	4ee8 <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	8a650513          	addi	a0,a0,-1882 # 5868 <malloc+0x8cc>
     fca:	71f030ef          	jal	4ee8 <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	0be98993          	addi	s3,s3,190 # 50d8 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	92878793          	addi	a5,a5,-1752 # 69b8 <malloc+0x1a1c>
  ...
  if(pid == 0){
    ...
    10e8:	35478793          	addi	a5,a5,852 # 7438 <malloc+0x249c>
    ...
    110c:	fd050513          	addi	a0,a0,-48 # 50d8 <malloc+0x13c>
    ...
    1120:	7f450513          	addi	a0,a0,2036 # 5910 <malloc+0x974>
    1124:	5c5030ef          	jal	4ee8 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	75450513          	addi	a0,a0,1876 # 5888 <malloc+0x8ec>
    113c:	5ad030ef          	jal	4ee8 <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	75c50513          	addi	a0,a0,1884 # 58a8 <malloc+0x90c>
    1154:	595030ef          	jal	4ee8 <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	76250513          	addi	a0,a0,1890 # 58c8 <malloc+0x92c>
    116e:	57b030ef          	jal	4ee8 <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	77250513          	addi	a0,a0,1906 # 58f0 <malloc+0x954>
    1186:	563030ef          	jal	4ee8 <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	0f5030ef          	jal	4a80 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	d4850513          	addi	a0,a0,-696 # 6ed8 <malloc+0x1f3c>
    1198:	551030ef          	jal	4ee8 <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	76e50513          	addi	a0,a0,1902 # 5938 <malloc+0x99c>
    11d2:	517030ef          	jal	4ee8 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	f4450513          	addi	a0,a0,-188 # 5130 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    1216:	f1ea0a13          	addi	s4,s4,-226 # 5130 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	77ea8a93          	addi	s5,s5,1918 # 5998 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	6f250513          	addi	a0,a0,1778 # 5968 <malloc+0x9cc>
    127e:	46b030ef          	jal	4ee8 <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	6f650513          	addi	a0,a0,1782 # 5980 <malloc+0x9e4>
    1292:	457030ef          	jal	4ee8 <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	70850513          	addi	a0,a0,1800 # 59a8 <malloc+0xa0c>
    12a8:	441030ef          	jal	4ee8 <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	e72a0a13          	addi	s4,s4,-398 # 5130 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    12c6:	00004a97          	auipc	s5,0x4
    12ca:	702a8a93          	addi	s5,s5,1794 # 59c8 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	e3050513          	addi	a0,a0,-464 # 5130 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    131a:	66a50513          	addi	a0,a0,1642 # 5980 <malloc+0x9e4>
    131e:	3cb030ef          	jal	4ee8 <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	6a450513          	addi	a0,a0,1700 # 59d0 <malloc+0xa34>
    1334:	3b5030ef          	jal	4ee8 <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	d8e78793          	addi	a5,a5,-626 # 50d8 <malloc+0x13c>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00004797          	auipc	a5,0x4
    135a:	69a78793          	addi	a5,a5,1690 # 59f0 <malloc+0xa54>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00004517          	auipc	a0,0x4
    136a:	69250513          	addi	a0,a0,1682 # 59f8 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    138e:	66e50513          	addi	a0,a0,1646 # 59f8 <malloc+0xa5c>
    ...
    13a6:	67650513          	addi	a0,a0,1654 # 5a18 <malloc+0xa7c>
    13aa:	33f030ef          	jal	4ee8 <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	5b050513          	addi	a0,a0,1456 # 5968 <malloc+0x9cc>
    13c0:	329030ef          	jal	4ee8 <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	63450513          	addi	a0,a0,1588 # 5a00 <malloc+0xa64>
    13d4:	315030ef          	jal	4ee8 <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	cf650513          	addi	a0,a0,-778 # 50d8 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    140e:	61e50513          	addi	a0,a0,1566 # 5a28 <malloc+0xa8c>
    1412:	2d7030ef          	jal	4ee8 <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	62250513          	addi	a0,a0,1570 # 5a40 <malloc+0xaa4>
    1426:	2c3030ef          	jal	4ee8 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	5ca50513          	addi	a0,a0,1482 # 59f8 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	05850513          	addi	a0,a0,88 # 54a8 <malloc+0x50c>
    1458:	291030ef          	jal	4ee8 <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	51c50513          	addi	a0,a0,1308 # 5980 <malloc+0x9e4>
    146c:	27d030ef          	jal	4ee8 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	60e030ef          	jal	4a80 <exit>
  unlink("echo-ok");
    1476:	00004517          	auipc	a0,0x4
    147a:	58250513          	addi	a0,a0,1410 # 59f8 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	5bc50513          	addi	a0,a0,1468 # 5a58 <malloc+0xabc>
    14a4:	245030ef          	jal	4ee8 <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	52850513          	addi	a0,a0,1320 # 5a70 <malloc+0xad4>
    1550:	199030ef          	jal	4ee8 <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	4c650513          	addi	a0,a0,1222 # 5a88 <malloc+0xaec>
    15ca:	11f030ef          	jal	4ee8 <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	4ca50513          	addi	a0,a0,1226 # 5aa0 <malloc+0xb04>
    15de:	10b030ef          	jal	4ee8 <printf>
          return;
    ...
    160a:	4b250513          	addi	a0,a0,1202 # 5ab8 <malloc+0xb1c>
    160e:	0db030ef          	jal	4ee8 <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	49a50513          	addi	a0,a0,1178 # 5ad8 <malloc+0xb3c>
    1646:	0a3030ef          	jal	4ee8 <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	2c850513          	addi	a0,a0,712 # 5968 <malloc+0x9cc>
    16a8:	041030ef          	jal	4ee8 <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	43c50513          	addi	a0,a0,1084 # 5af0 <malloc+0xb54>
    16bc:	02d030ef          	jal	4ee8 <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	44050513          	addi	a0,a0,1088 # 5b08 <malloc+0xb6c>
    16d0:	019030ef          	jal	4ee8 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	24450513          	addi	a0,a0,580 # 5968 <malloc+0x9cc>
    172c:	7bc030ef          	jal	4ee8 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	22c50513          	addi	a0,a0,556 # 5968 <malloc+0x9cc>
    1744:	7a4030ef          	jal	4ee8 <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	38e50513          	addi	a0,a0,910 # 5b28 <malloc+0xb8c>
    17a2:	746030ef          	jal	4ee8 <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	2d8030ef          	jal	4a80 <exit>
{
    ...
    17da:	36250513          	addi	a0,a0,866 # 5b38 <malloc+0xb9c>
    17de:	70a030ef          	jal	4ee8 <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	6c850513          	addi	a0,a0,1736 # 6ed8 <malloc+0x1f3c>
    1818:	6d0030ef          	jal	4ee8 <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	0d650513          	addi	a0,a0,214 # 5968 <malloc+0x9cc>
    189a:	64e030ef          	jal	4ee8 <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	14a50513          	addi	a0,a0,330 # 5a00 <malloc+0xa64>
    18be:	62a030ef          	jal	4ee8 <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	24450513          	addi	a0,a0,580 # 5b58 <malloc+0xbbc>
    191c:	5cc030ef          	jal	4ee8 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	23850513          	addi	a0,a0,568 # 5b70 <malloc+0xbd4>
    1940:	5a8030ef          	jal	4ee8 <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	20e50513          	addi	a0,a0,526 # 5b98 <malloc+0xbfc>
    1992:	556030ef          	jal	4ee8 <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	72450513          	addi	a0,a0,1828 # 5148 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	6f0b0b13          	addi	s6,s6,1776 # 5148 <malloc+0x1ac>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	160c0c13          	addi	s8,s8,352 # 5bc0 <malloc+0xc24>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	efc50513          	addi	a0,a0,-260 # 5968 <malloc+0x9cc>
    1a74:	474030ef          	jal	4ee8 <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	10450513          	addi	a0,a0,260 # 5c10 <malloc+0xc74>
    1b14:	3d4030ef          	jal	4ee8 <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	0a450513          	addi	a0,a0,164 # 5bc8 <malloc+0xc2c>
    1b2c:	3bc030ef          	jal	4ee8 <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	0a850513          	addi	a0,a0,168 # 5be0 <malloc+0xc44>
    1b40:	3a8030ef          	jal	4ee8 <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	0ac50513          	addi	a0,a0,172 # 5bf8 <malloc+0xc5c>
    1b54:	394030ef          	jal	4ee8 <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	d7e50513          	addi	a0,a0,-642 # 5968 <malloc+0x9cc>
    1bf2:	2f6030ef          	jal	4ee8 <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	03450513          	addi	a0,a0,52 # 5c38 <malloc+0xc9c>
    1c0c:	2dc030ef          	jal	4ee8 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	cf650513          	addi	a0,a0,-778 # 5968 <malloc+0x9cc>
    1c7a:	26e030ef          	jal	4ee8 <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	fc250513          	addi	a0,a0,-62 # 5c58 <malloc+0xcbc>
    1c9e:	24a030ef          	jal	4ee8 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	f8a50513          	addi	a0,a0,-118 # 5c70 <malloc+0xcd4>
    1cee:	1fa030ef          	jal	4ee8 <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	c6e50513          	addi	a0,a0,-914 # 5968 <malloc+0x9cc>
    1d02:	1e6030ef          	jal	4ee8 <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	71678793          	addi	a5,a5,1814 # 7438 <malloc+0x249c>
  ...
  exit(0);
    ...
    1d8e:	f0e50513          	addi	a0,a0,-242 # 5c98 <malloc+0xcfc>
    1d92:	156030ef          	jal	4ee8 <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	bca50513          	addi	a0,a0,-1078 # 5968 <malloc+0x9cc>
    1da6:	142030ef          	jal	4ee8 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	0ce50513          	addi	a0,a0,206 # 6ed8 <malloc+0x1f3c>
    1e12:	0d6030ef          	jal	4ee8 <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	e1c50513          	addi	a0,a0,-484 # 5cb8 <malloc+0xd1c>
    1ea4:	044030ef          	jal	4ee8 <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	2f450513          	addi	a0,a0,756 # 51a8 <malloc+0x20c>
    1ebc:	02c030ef          	jal	4ee8 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	a9078793          	addi	a5,a5,-1392 # 69b8 <malloc+0x1a1c>
  ...
  if(ret != -1){
    ...
    1f66:	d6e50513          	addi	a0,a0,-658 # 5cd0 <malloc+0xd34>
    1f6a:	77f020ef          	jal	4ee8 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	91050513          	addi	a0,a0,-1776 # 5888 <malloc+0x8ec>
    1f80:	769020ef          	jal	4ee8 <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	91a50513          	addi	a0,a0,-1766 # 58a8 <malloc+0x90c>
    1f96:	753020ef          	jal	4ee8 <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	92250513          	addi	a0,a0,-1758 # 58c8 <malloc+0x92c>
    1fae:	73b020ef          	jal	4ee8 <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	93450513          	addi	a0,a0,-1740 # 58f0 <malloc+0x954>
    1fc4:	725020ef          	jal	4ee8 <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	d1850513          	addi	a0,a0,-744 # 5d10 <malloc+0xd74>
  ...
  if(n >= 0){
    ...
    2024:	d1050513          	addi	a0,a0,-752 # 5d30 <malloc+0xd94>
    2028:	6c1020ef          	jal	4ee8 <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	ca250513          	addi	a0,a0,-862 # 5cd8 <malloc+0xd3c>
    203e:	6ab020ef          	jal	4ee8 <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	ca650513          	addi	a0,a0,-858 # 5cf0 <malloc+0xd54>
    2052:	697020ef          	jal	4ee8 <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	229020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	cbc50513          	addi	a0,a0,-836 # 5d18 <malloc+0xd7c>
    2064:	685020ef          	jal	4ee8 <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	c9c50513          	addi	a0,a0,-868 # 5d10 <malloc+0xd74>
    207c:	255020ef          	jal	4ad0 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	22e50513          	addi	a0,a0,558 # 52b0 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    20a8:	cbc50513          	addi	a0,a0,-836 # 5d60 <malloc+0xdc4>
    20ac:	63d020ef          	jal	4ee8 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	1cf020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    20b6:	00004517          	auipc	a0,0x4
    20ba:	c6250513          	addi	a0,a0,-926 # 5d18 <malloc+0xd7c>
    20be:	62b020ef          	jal	4ee8 <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	c6850513          	addi	a0,a0,-920 # 5d88 <malloc+0xdec>
    2128:	5c1020ef          	jal	4ee8 <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	c3850513          	addi	a0,a0,-968 # 5da8 <malloc+0xe0c>
    2178:	571020ef          	jal	4ee8 <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	c4c50513          	addi	a0,a0,-948 # 5e08 <malloc+0xe6c>
    21c4:	525020ef          	jal	4ee8 <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	bf250513          	addi	a0,a0,-1038 # 5dc8 <malloc+0xe2c>
    21de:	50b020ef          	jal	4ee8 <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	bfe50513          	addi	a0,a0,-1026 # 5de8 <malloc+0xe4c>
    21f2:	4f7020ef          	jal	4ee8 <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22f0:	b3c50513          	addi	a0,a0,-1220 # 5e28 <malloc+0xe8c>
    22f4:	3f5020ef          	jal	4ee8 <printf>
    exit(1);
    22f8:	4505                	li	a0,1
    ...
    2304:	b7050513          	addi	a0,a0,-1168 # 5e70 <malloc+0xed4>
    2308:	3e1020ef          	jal	4ee8 <printf>
    exit(1);
    230c:	4505                	li	a0,1
    ...
    231c:	b7850513          	addi	a0,a0,-1160 # 5e90 <malloc+0xef4>
    2320:	3c9020ef          	jal	4ee8 <printf>
    exit(1);
    2324:	4505                	li	a0,1
    ...
    2334:	ba050513          	addi	a0,a0,-1120 # 5ed0 <malloc+0xf34>
    2338:	3b1020ef          	jal	4ee8 <printf>
    exit(1);
    233c:	4505                	li	a0,1
    ...
    2348:	bbc50513          	addi	a0,a0,-1092 # 5f00 <malloc+0xf64>
    234c:	39d020ef          	jal	4ee8 <printf>
    exit(1);
    2350:	4505                	li	a0,1
    ...
    2360:	bdc50513          	addi	a0,a0,-1060 # 5f38 <malloc+0xf9c>
    2364:	385020ef          	jal	4ee8 <printf>
    exit(1);
    2368:	4505                	li	a0,1
...
000000000000236e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    238e:	bd650513          	addi	a0,a0,-1066 # 5f60 <malloc+0xfc4>
    2392:	72e020ef          	jal	4ac0 <open>
    2396:	84aa                	mv	s1,a0
  unlink("sbrk");
    2398:	00004517          	auipc	a0,0x4
    239c:	bc850513          	addi	a0,a0,-1080 # 5f60 <malloc+0xfc4>
  ...
  if(pipe((int *) a) != 0){
    ...
    23dc:	b9050513          	addi	a0,a0,-1136 # 5f68 <malloc+0xfcc>
    23e0:	309020ef          	jal	4ee8 <printf>
    exit(1);
    23e4:	4505                	li	a0,1
    ...
    23f0:	b9450513          	addi	a0,a0,-1132 # 5f80 <malloc+0xfe4>
    23f4:	2f5020ef          	jal	4ee8 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    2404:	67050513          	addi	a0,a0,1648 # 5a70 <malloc+0xad4>
    2408:	2e1020ef          	jal	4ee8 <printf>
    exit(1);
    240c:	4505                	li	a0,1
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2426:	b7650513          	addi	a0,a0,-1162 # 5f98 <malloc+0xffc>
  ...
  close(fd);
    ...
    245e:	52650513          	addi	a0,a0,1318 # 5980 <malloc+0x9e4>
    2462:	287020ef          	jal	4ee8 <printf>
    exit(1);
    2466:	4505                	li	a0,1
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2494:	a4850513          	addi	a0,a0,-1464 # 6ed8 <malloc+0x1f3c>
    2498:	251020ef          	jal	4ee8 <printf>
    exit(1);
    249c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24ce:	a0e50513          	addi	a0,a0,-1522 # 6ed8 <malloc+0x1f3c>
    24d2:	217020ef          	jal	4ee8 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    250e:	9ce50513          	addi	a0,a0,-1586 # 6ed8 <malloc+0x1f3c>
    2512:	1d7020ef          	jal	4ee8 <printf>
    exit(1);
    2516:	4505                	li	a0,1
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    262e:	8ae50513          	addi	a0,a0,-1874 # 6ed8 <malloc+0x1f3c>
    2632:	0b7020ef          	jal	4ee8 <printf>
      exit(1);
    2636:	4505                	li	a0,1
    ...
    266e:	a6e50513          	addi	a0,a0,-1426 # 50d8 <malloc+0x13c>
    2672:	faa43c23          	sd	a0,-72(s0)
    2676:	00003797          	auipc	a5,0x3
    267a:	ad278793          	addi	a5,a5,-1326 # 5148 <malloc+0x1ac>
...
0000000000002694 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c4:	96050513          	addi	a0,a0,-1696 # 6020 <malloc+0x1084>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26da:	9c250513          	addi	a0,a0,-1598 # 6098 <malloc+0x10fc>
  ...
  unlink("12345678901234");
    ...
    275e:	84650513          	addi	a0,a0,-1978 # 5fa0 <malloc+0x1004>
    2762:	786020ef          	jal	4ee8 <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2772:	87a50513          	addi	a0,a0,-1926 # 5fe8 <malloc+0x104c>
    2776:	772020ef          	jal	4ee8 <printf>
    exit(1);
    277a:	4505                	li	a0,1
    ...
    2786:	8ce50513          	addi	a0,a0,-1842 # 6050 <malloc+0x10b4>
    278a:	75e020ef          	jal	4ee8 <printf>
    exit(1);
    278e:	4505                	li	a0,1
    ...
    279a:	93250513          	addi	a0,a0,-1742 # 60c8 <malloc+0x112c>
    279e:	74a020ef          	jal	4ee8 <printf>
    exit(1);
    27a2:	4505                	li	a0,1
    ...
    27ae:	97e50513          	addi	a0,a0,-1666 # 6128 <malloc+0x118c>
    27b2:	736020ef          	jal	4ee8 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
    ...
    27c2:	9c250513          	addi	a0,a0,-1598 # 6180 <malloc+0x11e4>
    27c6:	722020ef          	jal	4ee8 <printf>
    exit(1);
    27ca:	4505                	li	a0,1
...
00000000000027d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    280a:	9b250513          	addi	a0,a0,-1614 # 61b8 <malloc+0x121c>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2836:	99650513          	addi	a0,a0,-1642 # 61c8 <malloc+0x122c>
    283a:	6ae020ef          	jal	4ee8 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    28ac:	91050513          	addi	a0,a0,-1776 # 61b8 <malloc+0x121c>
    28b0:	238020ef          	jal	4ae8 <mkdir>
    28b4:	12050063          	beqz	a0,29d4 <diskfull+0x204>
  unlink("diskfulldir");
    28b8:	00004517          	auipc	a0,0x4
    28bc:	90050513          	addi	a0,a0,-1792 # 61b8 <malloc+0x121c>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29da:	81250513          	addi	a0,a0,-2030 # 61e8 <malloc+0x124c>
    29de:	50a020ef          	jal	4ee8 <printf>
...
00000000000029e4 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a40:	7e450513          	addi	a0,a0,2020 # 6220 <malloc+0x1284>
    2a44:	4a4020ef          	jal	4ee8 <printf>
    exit(1);
    2a48:	4505                	li	a0,1
    ...
    2a54:	7e850513          	addi	a0,a0,2024 # 6238 <malloc+0x129c>
    2a58:	490020ef          	jal	4ee8 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a68:	80450513          	addi	a0,a0,-2044 # 6268 <malloc+0x12cc>
    2a6c:	47c020ef          	jal	4ee8 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
    ...
    2a7c:	81850513          	addi	a0,a0,-2024 # 6290 <malloc+0x12f4>
    2a80:	468020ef          	jal	4ee8 <printf>
    exit(1);
    2a84:	4505                	li	a0,1
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2adc:	e9050513          	addi	a0,a0,-368 # 5968 <malloc+0x9cc>
    2ae0:	408020ef          	jal	4ee8 <printf>
    exit(1);
    2ae4:	4505                	li	a0,1
    ...
    2af0:	73450513          	addi	a0,a0,1844 # 6220 <malloc+0x1284>
    2af4:	3f4020ef          	jal	4ee8 <printf>
      exit(1);
    2af8:	4505                	li	a0,1
    ...
    2b04:	7a850513          	addi	a0,a0,1960 # 62a8 <malloc+0x130c>
    2b08:	3e0020ef          	jal	4ee8 <printf>
      exit(1);
    2b0c:	4505                	li	a0,1
    ...
    2b18:	75450513          	addi	a0,a0,1876 # 6268 <malloc+0x12cc>
    2b1c:	3cc020ef          	jal	4ee8 <printf>
      exit(1);
    2b20:	4505                	li	a0,1
...
0000000000002b36 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b92:	69250513          	addi	a0,a0,1682 # 6220 <malloc+0x1284>
    2b96:	352020ef          	jal	4ee8 <printf>
    exit(1);
    2b9a:	4505                	li	a0,1
    ...
    2ba6:	72650513          	addi	a0,a0,1830 # 62c8 <malloc+0x132c>
    2baa:	33e020ef          	jal	4ee8 <printf>
    exit(1);
    2bae:	4505                	li	a0,1
    ...
    2bba:	73250513          	addi	a0,a0,1842 # 62e8 <malloc+0x134c>
    2bbe:	32a020ef          	jal	4ee8 <printf>
    exit(1);
    2bc2:	4505                	li	a0,1
    ...
    2bce:	73650513          	addi	a0,a0,1846 # 6300 <malloc+0x1364>
    2bd2:	316020ef          	jal	4ee8 <printf>
    exit(1);
    2bd6:	4505                	li	a0,1
...
0000000000002bdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2bee:	85e50513          	addi	a0,a0,-1954 # 6448 <malloc+0x14ac>
    2bf2:	6df010ef          	jal	4ad0 <unlink>
  if(mkdir("dd") != 0){
    2bf6:	00003517          	auipc	a0,0x3
    2bfa:	72250513          	addi	a0,a0,1826 # 6318 <malloc+0x137c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2c0e:	72e50513          	addi	a0,a0,1838 # 6338 <malloc+0x139c>
  ...
  write(fd, "ff", 2);
    ...
    2c22:	82a58593          	addi	a1,a1,-2006 # 6448 <malloc+0x14ac>
  ...
  if(unlink("dd") >= 0){
    ...
    2c34:	6e850513          	addi	a0,a0,1768 # 6318 <malloc+0x137c>
    2c38:	699010ef          	jal	4ad0 <unlink>
    2c3c:	2c055963          	bgez	a0,2f0e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c40:	00003517          	auipc	a0,0x3
    2c44:	75050513          	addi	a0,a0,1872 # 6390 <malloc+0x13f4>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c58:	76450513          	addi	a0,a0,1892 # 63b8 <malloc+0x141c>
  ...
  write(fd, "FF", 2);
    ...
    2c6c:	78058593          	addi	a1,a1,1920 # 63e8 <malloc+0x144c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c80:	77450513          	addi	a0,a0,1908 # 63f0 <malloc+0x1454>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d66:	65650513          	addi	a0,a0,1622 # 63b8 <malloc+0x141c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d7a:	85a50513          	addi	a0,a0,-1958 # 65d0 <malloc+0x1634>
  ...
  if(unlink("dd") < 0){
    ...
    2eec:	43850513          	addi	a0,a0,1080 # 6320 <malloc+0x1384>
    2ef0:	7f9010ef          	jal	4ee8 <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f00:	44450513          	addi	a0,a0,1092 # 6340 <malloc+0x13a4>
    2f04:	7e5010ef          	jal	4ee8 <printf>
    exit(1);
    2f08:	4505                	li	a0,1
    ...
    2f14:	45050513          	addi	a0,a0,1104 # 6360 <malloc+0x13c4>
    2f18:	7d1010ef          	jal	4ee8 <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f28:	47450513          	addi	a0,a0,1140 # 6398 <malloc+0x13fc>
    2f2c:	7bd010ef          	jal	4ee8 <printf>
    exit(1);
    2f30:	4505                	li	a0,1
    ...
    2f3c:	49050513          	addi	a0,a0,1168 # 63c8 <malloc+0x142c>
    2f40:	7a9010ef          	jal	4ee8 <printf>
    exit(1);
    2f44:	4505                	li	a0,1
    ...
    2f50:	4b450513          	addi	a0,a0,1204 # 6400 <malloc+0x1464>
    2f54:	795010ef          	jal	4ee8 <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f64:	4c050513          	addi	a0,a0,1216 # 6420 <malloc+0x1484>
    2f68:	781010ef          	jal	4ee8 <printf>
    exit(1);
    2f6c:	4505                	li	a0,1
    ...
    2f78:	4dc50513          	addi	a0,a0,1244 # 6450 <malloc+0x14b4>
    2f7c:	76d010ef          	jal	4ee8 <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f8c:	4f050513          	addi	a0,a0,1264 # 6478 <malloc+0x14dc>
    2f90:	759010ef          	jal	4ee8 <printf>
    exit(1);
    2f94:	4505                	li	a0,1
    ...
    2fa0:	4fc50513          	addi	a0,a0,1276 # 6498 <malloc+0x14fc>
    2fa4:	745010ef          	jal	4ee8 <printf>
    exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2fb4:	51050513          	addi	a0,a0,1296 # 64c0 <malloc+0x1524>
    2fb8:	731010ef          	jal	4ee8 <printf>
    exit(1);
    2fbc:	4505                	li	a0,1
    ...
    2fc8:	52450513          	addi	a0,a0,1316 # 64e8 <malloc+0x154c>
    2fcc:	71d010ef          	jal	4ee8 <printf>
    exit(1);
    2fd0:	4505                	li	a0,1
    ...
    2fdc:	54050513          	addi	a0,a0,1344 # 6518 <malloc+0x157c>
    2fe0:	709010ef          	jal	4ee8 <printf>
    exit(1);
    2fe4:	4505                	li	a0,1
    ...
    2ff0:	55c50513          	addi	a0,a0,1372 # 6548 <malloc+0x15ac>
    2ff4:	6f5010ef          	jal	4ee8 <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3004:	56050513          	addi	a0,a0,1376 # 6560 <malloc+0x15c4>
    3008:	6e1010ef          	jal	4ee8 <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    3018:	56c50513          	addi	a0,a0,1388 # 6580 <malloc+0x15e4>
    301c:	6cd010ef          	jal	4ee8 <printf>
    exit(1);
    3020:	4505                	li	a0,1
    ...
    302c:	57850513          	addi	a0,a0,1400 # 65a0 <malloc+0x1604>
    3030:	6b9010ef          	jal	4ee8 <printf>
    exit(1);
    3034:	4505                	li	a0,1
    ...
    3040:	5a450513          	addi	a0,a0,1444 # 65e0 <malloc+0x1644>
    3044:	6a5010ef          	jal	4ee8 <printf>
    exit(1);
    3048:	4505                	li	a0,1
    ...
    3054:	5c050513          	addi	a0,a0,1472 # 6610 <malloc+0x1674>
    3058:	691010ef          	jal	4ee8 <printf>
    exit(1);
    305c:	4505                	li	a0,1
    ...
    3068:	5cc50513          	addi	a0,a0,1484 # 6630 <malloc+0x1694>
    306c:	67d010ef          	jal	4ee8 <printf>
    exit(1);
    3070:	4505                	li	a0,1
    ...
    307c:	5d850513          	addi	a0,a0,1496 # 6650 <malloc+0x16b4>
    3080:	669010ef          	jal	4ee8 <printf>
    exit(1);
    3084:	4505                	li	a0,1
    ...
    3090:	5e450513          	addi	a0,a0,1508 # 6670 <malloc+0x16d4>
    3094:	655010ef          	jal	4ee8 <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a4:	60050513          	addi	a0,a0,1536 # 66a0 <malloc+0x1704>
    30a8:	641010ef          	jal	4ee8 <printf>
    exit(1);
    30ac:	4505                	li	a0,1
    ...
    30b8:	61450513          	addi	a0,a0,1556 # 66c8 <malloc+0x172c>
    30bc:	62d010ef          	jal	4ee8 <printf>
    exit(1);
    30c0:	4505                	li	a0,1
    ...
    30cc:	62850513          	addi	a0,a0,1576 # 66f0 <malloc+0x1754>
    30d0:	619010ef          	jal	4ee8 <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    ...
    30e0:	63c50513          	addi	a0,a0,1596 # 6718 <malloc+0x177c>
    30e4:	605010ef          	jal	4ee8 <printf>
    exit(1);
    30e8:	4505                	li	a0,1
    ...
    30f4:	64850513          	addi	a0,a0,1608 # 6738 <malloc+0x179c>
    30f8:	5f1010ef          	jal	4ee8 <printf>
    exit(1);
    30fc:	4505                	li	a0,1
    ...
    3108:	65450513          	addi	a0,a0,1620 # 6758 <malloc+0x17bc>
    310c:	5dd010ef          	jal	4ee8 <printf>
    exit(1);
    3110:	4505                	li	a0,1
    ...
    311c:	66850513          	addi	a0,a0,1640 # 6780 <malloc+0x17e4>
    3120:	5c9010ef          	jal	4ee8 <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3130:	67450513          	addi	a0,a0,1652 # 67a0 <malloc+0x1804>
    3134:	5b5010ef          	jal	4ee8 <printf>
    exit(1);
    3138:	4505                	li	a0,1
    ...
    3144:	68050513          	addi	a0,a0,1664 # 67c0 <malloc+0x1824>
    3148:	5a1010ef          	jal	4ee8 <printf>
    exit(1);
    314c:	4505                	li	a0,1
    ...
    3158:	69450513          	addi	a0,a0,1684 # 67e8 <malloc+0x184c>
    315c:	58d010ef          	jal	4ee8 <printf>
    exit(1);
    3160:	4505                	li	a0,1
    ...
    316c:	31050513          	addi	a0,a0,784 # 6478 <malloc+0x14dc>
    3170:	579010ef          	jal	4ee8 <printf>
    exit(1);
    3174:	4505                	li	a0,1
    ...
    3180:	68c50513          	addi	a0,a0,1676 # 6808 <malloc+0x186c>
    3184:	565010ef          	jal	4ee8 <printf>
    exit(1);
    3188:	4505                	li	a0,1
    ...
    3194:	69850513          	addi	a0,a0,1688 # 6828 <malloc+0x188c>
    3198:	551010ef          	jal	4ee8 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31a8:	6b450513          	addi	a0,a0,1716 # 6858 <malloc+0x18bc>
    31ac:	53d010ef          	jal	4ee8 <printf>
    exit(1);
    31b0:	4505                	li	a0,1
    ...
    31bc:	6c050513          	addi	a0,a0,1728 # 6878 <malloc+0x18dc>
    31c0:	529010ef          	jal	4ee8 <printf>
    exit(1);
    31c4:	4505                	li	a0,1
...
00000000000031ca <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3256:	64650513          	addi	a0,a0,1606 # 6898 <malloc+0x18fc>
    325a:	48f010ef          	jal	4ee8 <printf>
    exit(1);
    325e:	4505                	li	a0,1
    ...
    326a:	64a50513          	addi	a0,a0,1610 # 68b0 <malloc+0x1914>
    326e:	47b010ef          	jal	4ee8 <printf>
    exit(1);
    3272:	4505                	li	a0,1
    ...
    327e:	64e50513          	addi	a0,a0,1614 # 68c8 <malloc+0x192c>
    3282:	467010ef          	jal	4ee8 <printf>
    exit(1);
    3286:	4505                	li	a0,1
    ...
    3292:	65250513          	addi	a0,a0,1618 # 68e0 <malloc+0x1944>
    3296:	453010ef          	jal	4ee8 <printf>
    exit(1);
    329a:	4505                	li	a0,1
    ...
    32a6:	fee50513          	addi	a0,a0,-18 # 6290 <malloc+0x12f4>
    32aa:	43f010ef          	jal	4ee8 <printf>
    exit(1);
    32ae:	4505                	li	a0,1
    ...
    32ba:	64a50513          	addi	a0,a0,1610 # 6900 <malloc+0x1964>
    32be:	42b010ef          	jal	4ee8 <printf>
    exit(1);
    32c2:	4505                	li	a0,1
    ...
    32ce:	65e50513          	addi	a0,a0,1630 # 6928 <malloc+0x198c>
    32d2:	417010ef          	jal	4ee8 <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e2:	66a50513          	addi	a0,a0,1642 # 6948 <malloc+0x19ac>
    32e6:	403010ef          	jal	4ee8 <printf>
    exit(1);
    32ea:	4505                	li	a0,1
...
00000000000032f0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3306:	66650513          	addi	a0,a0,1638 # 6968 <malloc+0x19cc>
  ...
  if(chdir("dirfile") == 0){
    ...
    331a:	65250513          	addi	a0,a0,1618 # 6968 <malloc+0x19cc>
    331e:	7d2010ef          	jal	4af0 <chdir>
    3322:	c569                	beqz	a0,33ec <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3324:	4581                	li	a1,0
    3326:	00003517          	auipc	a0,0x3
    332a:	68a50513          	addi	a0,a0,1674 # 69b0 <malloc+0x1a14>
  ...
  fd = open(".", 0);
    ...
    33aa:	41a50513          	addi	a0,a0,1050 # 57c0 <malloc+0x824>
    33ae:	712010ef          	jal	4ac0 <open>
    33b2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    33b4:	4605                	li	a2,1
    33b6:	00002597          	auipc	a1,0x2
    33ba:	d9258593          	addi	a1,a1,-622 # 5148 <malloc+0x1ac>
  ...
  close(fd);
    ...
    33de:	59650513          	addi	a0,a0,1430 # 6970 <malloc+0x19d4>
    33e2:	307010ef          	jal	4ee8 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	5a250513          	addi	a0,a0,1442 # 6990 <malloc+0x19f4>
    33f6:	2f3010ef          	jal	4ee8 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	5be50513          	addi	a0,a0,1470 # 69c0 <malloc+0x1a24>
    340a:	2df010ef          	jal	4ee8 <printf>
    exit(1);
    340e:	4505                	li	a0,1
    ...
    341a:	5aa50513          	addi	a0,a0,1450 # 69c0 <malloc+0x1a24>
    341e:	2cb010ef          	jal	4ee8 <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    342e:	5be50513          	addi	a0,a0,1470 # 69e8 <malloc+0x1a4c>
    3432:	2b7010ef          	jal	4ee8 <printf>
    exit(1);
    3436:	4505                	li	a0,1
    ...
    3442:	5d250513          	addi	a0,a0,1490 # 6a10 <malloc+0x1a74>
    3446:	2a3010ef          	jal	4ee8 <printf>
    exit(1);
    344a:	4505                	li	a0,1
    ...
    3456:	5e650513          	addi	a0,a0,1510 # 6a38 <malloc+0x1a9c>
    345a:	28f010ef          	jal	4ee8 <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346a:	5fa50513          	addi	a0,a0,1530 # 6a60 <malloc+0x1ac4>
    346e:	27b010ef          	jal	4ee8 <printf>
    exit(1);
    3472:	4505                	li	a0,1
    ...
    347e:	60650513          	addi	a0,a0,1542 # 6a80 <malloc+0x1ae4>
    3482:	267010ef          	jal	4ee8 <printf>
    exit(1);
    3486:	4505                	li	a0,1
    ...
    3492:	61a50513          	addi	a0,a0,1562 # 6aa8 <malloc+0x1b0c>
    3496:	253010ef          	jal	4ee8 <printf>
    exit(1);
    349a:	4505                	li	a0,1
...
00000000000034a0 <iref>:
{
    ...
    34be:	606a0a13          	addi	s4,s4,1542 # 6ac0 <malloc+0x1b24>
    mkdir("");
    34c2:	00003497          	auipc	s1,0x3
    34c6:	10648493          	addi	s1,s1,262 # 65c8 <malloc+0x162c>
    link("README", "");
    34ca:	00002a97          	auipc	s5,0x2
    34ce:	de6a8a93          	addi	s5,s5,-538 # 52b0 <malloc+0x314>
    fd = open("xx", O_CREATE);
    34d2:	00003997          	auipc	s3,0x3
    34d6:	4e698993          	addi	s3,s3,1254 # 69b8 <malloc+0x1a1c>
    34da:	a835                	j	3516 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34dc:	85da                	mv	a1,s6
    34de:	00003517          	auipc	a0,0x3
    34e2:	5ea50513          	addi	a0,a0,1514 # 6ac8 <malloc+0x1b2c>
    34e6:	203010ef          	jal	4ee8 <printf>
      exit(1);
    34ea:	4505                	li	a0,1
    ...
    34f6:	5ee50513          	addi	a0,a0,1518 # 6ae0 <malloc+0x1b44>
    34fa:	1ef010ef          	jal	4ee8 <printf>
      exit(1);
    34fe:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    355e:	d8698993          	addi	s3,s3,-634 # 62e0 <malloc+0x1344>
    unlink("irefd");
    3562:	00003917          	auipc	s2,0x3
    3566:	55e90913          	addi	s2,s2,1374 # 6ac0 <malloc+0x1b24>
    chdir("..");
    356a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    357e:	d0e50513          	addi	a0,a0,-754 # 6288 <malloc+0x12ec>
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35aa:	55250513          	addi	a0,a0,1362 # 6af8 <malloc+0x1b5c>
  ...
  if(pid == 0){
    ...
    35c6:	53650513          	addi	a0,a0,1334 # 6af8 <malloc+0x1b5c>
    ...
    35d8:	54450513          	addi	a0,a0,1348 # 6b18 <malloc+0x1b7c>
    35dc:	10d010ef          	jal	4ee8 <printf>
      exit(1);
    35e0:	4505                	li	a0,1
    ...
    35ec:	51850513          	addi	a0,a0,1304 # 6b00 <malloc+0x1b64>
    35f0:	0f9010ef          	jal	4ee8 <printf>
    exit(1);
    35f4:	4505                	li	a0,1
    ...
    3600:	36c50513          	addi	a0,a0,876 # 5968 <malloc+0x9cc>
    3604:	0e5010ef          	jal	4ee8 <printf>
    exit(1);
    3608:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    361e:	4de50513          	addi	a0,a0,1246 # 6af8 <malloc+0x1b5c>
    3622:	4ae010ef          	jal	4ad0 <unlink>
    3626:	c919                	beqz	a0,363c <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3628:	85a6                	mv	a1,s1
    362a:	00002517          	auipc	a0,0x2
    362e:	52e50513          	addi	a0,a0,1326 # 5b58 <malloc+0xbbc>
    3632:	0b7010ef          	jal	4ee8 <printf>
    exit(1);
    3636:	4505                	li	a0,1
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    365c:	4e850513          	addi	a0,a0,1256 # 6b40 <malloc+0x1ba4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    367c:	4c850513          	addi	a0,a0,1224 # 6b40 <malloc+0x1ba4>
  ...
  sleep(10); // one second
    ...
    36a4:	48850513          	addi	a0,a0,1160 # 5b28 <malloc+0xb8c>
    36a8:	041010ef          	jal	4ee8 <printf>
    exit(1);
    36ac:	4505                	li	a0,1
    36ae:	3d2010ef          	jal	4a80 <exit>
      int fd = open("stopforking", 0);
    36b2:	00003497          	auipc	s1,0x3
    36b6:	48e48493          	addi	s1,s1,1166 # 6b40 <malloc+0x1ba4>
    36ba:	4581                	li	a1,0
    36bc:	8526                	mv	a0,s1
    ...
    36d6:	46e50513          	addi	a0,a0,1134 # 6b40 <malloc+0x1ba4>
...
00000000000036ea <killstatus>:
{
  ...
  exit(0);
    ...
    373c:	23050513          	addi	a0,a0,560 # 5968 <malloc+0x9cc>
    3740:	7a8010ef          	jal	4ee8 <printf>
      exit(1);
    3744:	4505                	li	a0,1
    ...
    3756:	3fe50513          	addi	a0,a0,1022 # 6b50 <malloc+0x1bb4>
    375a:	78e010ef          	jal	4ee8 <printf>
       exit(1);
    375e:	4505                	li	a0,1
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    378a:	3a250513          	addi	a0,a0,930 # 5b28 <malloc+0xb8c>
    378e:	75a010ef          	jal	4ee8 <printf>
    exit(1);
    3792:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    37ac:	1c050513          	addi	a0,a0,448 # 5968 <malloc+0x9cc>
    37b0:	738010ef          	jal	4ee8 <printf>
    exit(1);
    37b4:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37dc:	97058593          	addi	a1,a1,-1680 # 5148 <malloc+0x1ac>
    ...
    37fe:	16e50513          	addi	a0,a0,366 # 5968 <malloc+0x9cc>
    3802:	6e6010ef          	jal	4ee8 <printf>
     exit(1);
    3806:	4505                	li	a0,1
    ...
    3812:	36250513          	addi	a0,a0,866 # 6b70 <malloc+0x1bd4>
    3816:	6d2010ef          	jal	4ee8 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3842:	34a50513          	addi	a0,a0,842 # 6b88 <malloc+0x1bec>
    3846:	6a2010ef          	jal	4ee8 <printf>
}
  ...
  printf("kill... ");
    ...
    3866:	33e50513          	addi	a0,a0,830 # 6ba0 <malloc+0x1c04>
    386a:	67e010ef          	jal	4ee8 <printf>
  kill(pid1);
    386e:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3884:	33050513          	addi	a0,a0,816 # 6bb0 <malloc+0x1c14>
    3888:	660010ef          	jal	4ee8 <printf>
  wait(0);
    388c:	4501                	li	a0,0
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    38e4:	08850513          	addi	a0,a0,136 # 5968 <malloc+0x9cc>
    38e8:	600010ef          	jal	4ee8 <printf>
      exit(1);
    38ec:	4505                	li	a0,1
    ...
    38f8:	1fc50513          	addi	a0,a0,508 # 5af0 <malloc+0xb54>
    38fc:	5ec010ef          	jal	4ee8 <printf>
        exit(1);
    3900:	4505                	li	a0,1
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3952:	12250513          	addi	a0,a0,290 # 5a70 <malloc+0xad4>
    3956:	592010ef          	jal	4ee8 <printf>
    exit(1);
    395a:	4505                	li	a0,1
    ...
    3976:	7d658593          	addi	a1,a1,2006 # 5148 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3a16:	1ae50513          	addi	a0,a0,430 # 6bc0 <malloc+0x1c24>
    3a1a:	4ce010ef          	jal	4ee8 <printf>
    exit(1);
    3a1e:	4505                	li	a0,1
    ...
    3a2a:	f4250513          	addi	a0,a0,-190 # 5968 <malloc+0x9cc>
    3a2e:	4ba010ef          	jal	4ee8 <printf>
    exit(1);
    3a32:	4505                	li	a0,1
    ...
    3a66:	17e50513          	addi	a0,a0,382 # 6be0 <malloc+0x1c44>
    3a6a:	47e010ef          	jal	4ee8 <printf>
    exit(1);
    3a6e:	4505                	li	a0,1
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3abe:	6084                	ld	s1,0(s1)
      free(m1);
    3ac0:	45a010ef          	jal	4f1a <free>
    while(m1){
    3ac4:	fce5                	bnez	s1,3abc <mem+0x42>
    m1 = malloc(1024*20);
    3ac6:	6515                	lui	a0,0x5
    3ac8:	4d4010ef          	jal	4f9c <malloc>
    if(m1 == 0){
    3acc:	c511                	beqz	a0,3ad8 <mem+0x5e>
    free(m1);
    3ace:	44c010ef          	jal	4f1a <free>
    exit(0);
    3ad2:	4501                	li	a0,0
    ...
    3ade:	13650513          	addi	a0,a0,310 # 6c10 <malloc+0x1c74>
    3ae2:	406010ef          	jal	4ee8 <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
...
0000000000003af2 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b02:	13250513          	addi	a0,a0,306 # 6c30 <malloc+0x1c94>
    3b06:	7cb000ef          	jal	4ad0 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b0a:	20200593          	li	a1,514
    3b0e:	00003517          	auipc	a0,0x3
    3b12:	12250513          	addi	a0,a0,290 # 6c30 <malloc+0x1c94>
  ...
  if(pid == 0) {
    ...
    3b7c:	0c850513          	addi	a0,a0,200 # 6c40 <malloc+0x1ca4>
    3b80:	368010ef          	jal	4ee8 <printf>
    exit(1);
    3b84:	4505                	li	a0,1
    ...
    3b90:	0dc50513          	addi	a0,a0,220 # 6c68 <malloc+0x1ccc>
    3b94:	354010ef          	jal	4ee8 <printf>
      exit(1);
    3b98:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bc0:	07450513          	addi	a0,a0,116 # 6c30 <malloc+0x1c94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bf8:	09450513          	addi	a0,a0,148 # 6c88 <malloc+0x1cec>
    3bfc:	2ec010ef          	jal	4ee8 <printf>
    exit(1);
    3c00:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c28:	00c50513          	addi	a0,a0,12 # 6c30 <malloc+0x1c94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c4a:	06a50513          	addi	a0,a0,106 # 6cb0 <malloc+0x1d14>
    3c4e:	29a010ef          	jal	4ee8 <printf>
    exit(1);
    3c52:	4505                	li	a0,1
...
0000000000003c5e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c82:	04a78793          	addi	a5,a5,74 # 6cc8 <malloc+0x1d2c>
    3c86:	f6f43823          	sd	a5,-144(s0)
    3c8a:	00003797          	auipc	a5,0x3
    3c8e:	04678793          	addi	a5,a5,70 # 6cd0 <malloc+0x1d34>
    3c92:	f6f43c23          	sd	a5,-136(s0)
    3c96:	00003797          	auipc	a5,0x3
    3c9a:	04278793          	addi	a5,a5,66 # 6cd8 <malloc+0x1d3c>
    3c9e:	f8f43023          	sd	a5,-128(s0)
    3ca2:	00003797          	auipc	a5,0x3
    3ca6:	03e78793          	addi	a5,a5,62 # 6ce0 <malloc+0x1d44>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d08:	c6450513          	addi	a0,a0,-924 # 5968 <malloc+0x9cc>
    3d0c:	1dc010ef          	jal	4ee8 <printf>
      exit(1);
    3d10:	4505                	li	a0,1
    ...
    3d6a:	c9a50513          	addi	a0,a0,-870 # 5a00 <malloc+0xa64>
    3d6e:	17a010ef          	jal	4ee8 <printf>
        exit(1);
    3d72:	4505                	li	a0,1
    3d74:	50d000ef          	jal	4a80 <exit>
          printf("write failed %d\n", n);
    3d78:	00003517          	auipc	a0,0x3
    3d7c:	f7050513          	addi	a0,a0,-144 # 6ce8 <malloc+0x1d4c>
    3d80:	168010ef          	jal	4ee8 <printf>
          exit(1);
    3d84:	4505                	li	a0,1
    ...
    3d96:	f6e50513          	addi	a0,a0,-146 # 6d00 <malloc+0x1d64>
    3d9a:	14e010ef          	jal	4ee8 <printf>
          exit(1);
    3d9e:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e06:	f0e50513          	addi	a0,a0,-242 # 6d10 <malloc+0x1d74>
    3e0a:	0de010ef          	jal	4ee8 <printf>
      exit(1);
    3e0e:	4505                	li	a0,1
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e60:	eccb8b93          	addi	s7,s7,-308 # 6d28 <malloc+0x1d8c>
  for(i = 0; i < N; i++){
    ...
    3e9a:	e9a50513          	addi	a0,a0,-358 # 6d30 <malloc+0x1d94>
    3e9e:	04a010ef          	jal	4ee8 <printf>
        exit(1);
    3ea2:	4505                	li	a0,1
    ...
    3eb0:	e7c50513          	addi	a0,a0,-388 # 6d28 <malloc+0x1d8c>
  ...
  fd = open(".", 0);
    ...
    3ed8:	8ec50513          	addi	a0,a0,-1812 # 57c0 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f48:	e0c50513          	addi	a0,a0,-500 # 6d50 <malloc+0x1db4>
    3f4c:	79d000ef          	jal	4ee8 <printf>
        exit(1);
    3f50:	4505                	li	a0,1
    ...
    3f60:	e1450513          	addi	a0,a0,-492 # 6d70 <malloc+0x1dd4>
    3f64:	785000ef          	jal	4ee8 <printf>
        exit(1);
    3f68:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f8c:	e1050513          	addi	a0,a0,-496 # 6d98 <malloc+0x1dfc>
    3f90:	759000ef          	jal	4ee8 <printf>
    exit(1);
    3f94:	4505                	li	a0,1
    ...
    3fa0:	9cc50513          	addi	a0,a0,-1588 # 5968 <malloc+0x9cc>
    3fa4:	745000ef          	jal	4ee8 <printf>
      exit(1);
    3fa8:	4505                	li	a0,1
...
00000000000040d6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ee:	ce650513          	addi	a0,a0,-794 # 6dd0 <malloc+0x1e34>
    40f2:	1df000ef          	jal	4ad0 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40f6:	20200593          	li	a1,514
    40fa:	00003517          	auipc	a0,0x3
    40fe:	cd650513          	addi	a0,a0,-810 # 6dd0 <malloc+0x1e34>
  ...
  fd = open("bigfile.dat", 0);
    ...
    414a:	c8a50513          	addi	a0,a0,-886 # 6dd0 <malloc+0x1e34>
  ...
  for(i = 0; ; i++){
    ...
    41a6:	c3e50513          	addi	a0,a0,-962 # 6de0 <malloc+0x1e44>
    41aa:	53f000ef          	jal	4ee8 <printf>
    exit(1);
    41ae:	4505                	li	a0,1
    ...
    41ba:	c4a50513          	addi	a0,a0,-950 # 6e00 <malloc+0x1e64>
    41be:	52b000ef          	jal	4ee8 <printf>
      exit(1);
    41c2:	4505                	li	a0,1
    ...
    41ce:	c5650513          	addi	a0,a0,-938 # 6e20 <malloc+0x1e84>
    41d2:	517000ef          	jal	4ee8 <printf>
    exit(1);
    41d6:	4505                	li	a0,1
    ...
    41e2:	c6250513          	addi	a0,a0,-926 # 6e40 <malloc+0x1ea4>
    41e6:	503000ef          	jal	4ee8 <printf>
      exit(1);
    41ea:	4505                	li	a0,1
    ...
    41f6:	c6e50513          	addi	a0,a0,-914 # 6e60 <malloc+0x1ec4>
    41fa:	4ef000ef          	jal	4ee8 <printf>
      exit(1);
    41fe:	4505                	li	a0,1
    ...
    420a:	c7250513          	addi	a0,a0,-910 # 6e78 <malloc+0x1edc>
    420e:	4db000ef          	jal	4ee8 <printf>
      exit(1);
    4212:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    422c:	ba850513          	addi	a0,a0,-1112 # 6dd0 <malloc+0x1e34>
    ...
    424c:	c5050513          	addi	a0,a0,-944 # 6e98 <malloc+0x1efc>
    4250:	499000ef          	jal	4ee8 <printf>
    exit(1);
    4254:	4505                	li	a0,1
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426a:	c5250513          	addi	a0,a0,-942 # 6eb8 <malloc+0x1f1c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4290:	c2c50513          	addi	a0,a0,-980 # 6eb8 <malloc+0x1f1c>
  ...
  close(fd);
    ...
    42ea:	df250513          	addi	a0,a0,-526 # 50d8 <malloc+0x13c>
    42ee:	7ca000ef          	jal	4ab8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	bc250513          	addi	a0,a0,-1086 # 6eb8 <malloc+0x1f1c>
    ...
    4312:	bba50513          	addi	a0,a0,-1094 # 6ec8 <malloc+0x1f2c>
    4316:	3d3000ef          	jal	4ee8 <printf>
    exit(1);
    431a:	4505                	li	a0,1
    ...
    432a:	bc250513          	addi	a0,a0,-1086 # 6ee8 <malloc+0x1f4c>
    432e:	3bb000ef          	jal	4ee8 <printf>
    exit(1);
    4332:	4505                	li	a0,1
...
0000000000004338 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4358:	bb450513          	addi	a0,a0,-1100 # 6f08 <malloc+0x1f6c>
    435c:	38d000ef          	jal	4ee8 <printf>
  for(nfiles = 0; ; nfiles++){
    4360:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4374:	ba8c8c93          	addi	s9,s9,-1112 # 6f18 <malloc+0x1f7c>
    name[0] = 'f';
    ...
    43dc:	b5050513          	addi	a0,a0,-1200 # 6f28 <malloc+0x1f8c>
    43e0:	309000ef          	jal	4ee8 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    444a:	b0250513          	addi	a0,a0,-1278 # 6f48 <malloc+0x1fac>
    444e:	29b000ef          	jal	4ee8 <printf>
}
    ...
    4498:	aa450513          	addi	a0,a0,-1372 # 6f38 <malloc+0x1f9c>
    449c:	24d000ef          	jal	4ee8 <printf>
    close(fd);
    44a0:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    44c2:	aa250513          	addi	a0,a0,-1374 # 6f60 <malloc+0x1fc4>
    44c6:	223000ef          	jal	4ee8 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    44e6:	aa650513          	addi	a0,a0,-1370 # 6f88 <malloc+0x1fec>
    44ea:	1ff000ef          	jal	4ee8 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4506:	a6e50513          	addi	a0,a0,-1426 # 6f70 <malloc+0x1fd4>
    450a:	1df000ef          	jal	4ee8 <printf>
    exit(1);
    450e:	4505                	li	a0,1
    ...
    4522:	a7250513          	addi	a0,a0,-1422 # 6f90 <malloc+0x1ff4>
    4526:	1c3000ef          	jal	4ee8 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    457a:	a2250513          	addi	a0,a0,-1502 # 6f98 <malloc+0x1ffc>
    457e:	16b000ef          	jal	4ee8 <printf>
          return 1;
    4582:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    45da:	b7298993          	addi	s3,s3,-1166 # 5148 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    4604:	9f050513          	addi	a0,a0,-1552 # 6ff0 <malloc+0x2054>
    4608:	0e1000ef          	jal	4ee8 <printf>
        exit(1);
    460c:	4505                	li	a0,1
    ...
    461c:	99850513          	addi	a0,a0,-1640 # 6fb0 <malloc+0x2014>
    4620:	0c9000ef          	jal	4ee8 <printf>
    exit(1);
    4624:	4505                	li	a0,1
    ...
    4634:	9a050513          	addi	a0,a0,-1632 # 6fd0 <malloc+0x2034>
    4638:	0b1000ef          	jal	4ee8 <printf>
    exit(1);
    463c:	4505                	li	a0,1
  ...
  while(1){
    ...
    4674:	9a050513          	addi	a0,a0,-1632 # 7010 <malloc+0x2074>
    4678:	071000ef          	jal	4ee8 <printf>
      exit(1);
    467c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    46c2:	972b8b93          	addi	s7,s7,-1678 # 7030 <malloc+0x2094>
    int free0 = countfree();
    int free1 = 0;
    ...
    46dc:	970d0d13          	addi	s10,s10,-1680 # 7048 <malloc+0x20ac>
          return 1;
        }
      }
    }
    ...
    46e4:	988c8c93          	addi	s9,s9,-1656 # 7068 <malloc+0x20cc>
    46e8:	a819                	j	46fe <drivetests+0x62>
        printf("usertests slow tests starting\n");
    46ea:	856a                	mv	a0,s10
    46ec:	7fc000ef          	jal	4ee8 <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    47a0:	8fc58593          	addi	a1,a1,-1796 # 7098 <malloc+0x20fc>
    47a4:	854a                	mv	a0,s2
    ...
    47b2:	8f258593          	addi	a1,a1,-1806 # 70a0 <malloc+0x2104>
    47b6:	854a                	mv	a0,s2
    47b8:	08c000ef          	jal	4844 <strcmp>
    47bc:	cd15                	beqz	a0,47f8 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    47be:	00003597          	auipc	a1,0x3
    47c2:	8ea58593          	addi	a1,a1,-1814 # 70a8 <malloc+0x210c>
    47c6:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    47e4:	8d050513          	addi	a0,a0,-1840 # 70b0 <malloc+0x2114>
    47e8:	700000ef          	jal	4ee8 <printf>
    exit(1);
    47ec:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4808:	8dc50513          	addi	a0,a0,-1828 # 70e0 <malloc+0x2144>
    480c:	6dc000ef          	jal	4ee8 <printf>
  exit(0);
    4810:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4b70:	1101                	addi	sp,sp,-32
    4b72:	ec06                	sd	ra,24(sp)
    4b74:	e822                	sd	s0,16(sp)
    4b76:	1000                	addi	s0,sp,32
    4b78:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4b7c:	4605                	li	a2,1
    4b7e:	fef40593          	addi	a1,s0,-17
    4b82:	f1fff0ef          	jal	4aa0 <write>
}
    4b86:	60e2                	ld	ra,24(sp)
    4b88:	6442                	ld	s0,16(sp)
    4b8a:	6105                	addi	sp,sp,32
    4b8c:	8082                	ret

0000000000004b8e <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4b8e:	7139                	addi	sp,sp,-64
    4b90:	fc06                	sd	ra,56(sp)
    4b92:	f822                	sd	s0,48(sp)
    4b94:	f426                	sd	s1,40(sp)
    4b96:	0080                	addi	s0,sp,64
    4b98:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4b9a:	c299                	beqz	a3,4ba0 <printint+0x12>
    4b9c:	0805c963          	bltz	a1,4c2e <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4ba0:	2581                	sext.w	a1,a1
  neg = 0;
    4ba2:	4881                	li	a7,0
    4ba4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4baa:	2601                	sext.w	a2,a2
    4bac:	00003517          	auipc	a0,0x3
    4bb0:	90450513          	addi	a0,a0,-1788 # 74b0 <digits>
    4bb4:	883a                	mv	a6,a4
    4bb6:	2705                	addiw	a4,a4,1
    4bb8:	02c5f7bb          	remuw	a5,a1,a2
    4bbc:	1782                	slli	a5,a5,0x20
    4bbe:	9381                	srli	a5,a5,0x20
    4bc0:	97aa                	add	a5,a5,a0
    4bc2:	0007c783          	lbu	a5,0(a5)
    4bc6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4bca:	0005879b          	sext.w	a5,a1
    4bce:	02c5d5bb          	divuw	a1,a1,a2
    4bd2:	0685                	addi	a3,a3,1
    4bd4:	fec7f0e3          	bgeu	a5,a2,4bb4 <printint+0x26>
  if(neg)
    4bd8:	00088c63          	beqz	a7,4bf0 <printint+0x62>
    buf[i++] = '-';
    4bdc:	fd070793          	addi	a5,a4,-48
    4be0:	00878733          	add	a4,a5,s0
    4be4:	02d00793          	li	a5,45
    4be8:	fef70823          	sb	a5,-16(a4)
    4bec:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4bf0:	02e05a63          	blez	a4,4c24 <printint+0x96>
    4bf4:	f04a                	sd	s2,32(sp)
    4bf6:	ec4e                	sd	s3,24(sp)
    4bf8:	fc040793          	addi	a5,s0,-64
    4bfc:	00e78933          	add	s2,a5,a4
    4c00:	fff78993          	addi	s3,a5,-1
    4c04:	99ba                	add	s3,s3,a4
    4c06:	377d                	addiw	a4,a4,-1
    4c08:	1702                	slli	a4,a4,0x20
    4c0a:	9301                	srli	a4,a4,0x20
    4c0c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4c10:	fff94583          	lbu	a1,-1(s2)
    4c14:	8526                	mv	a0,s1
    4c16:	f5bff0ef          	jal	4b70 <putc>
  while(--i >= 0)
    4c1a:	197d                	addi	s2,s2,-1
    4c1c:	ff391ae3          	bne	s2,s3,4c10 <printint+0x82>
    4c20:	7902                	ld	s2,32(sp)
    4c22:	69e2                	ld	s3,24(sp)
}
    4c24:	70e2                	ld	ra,56(sp)
    4c26:	7442                	ld	s0,48(sp)
    4c28:	74a2                	ld	s1,40(sp)
    4c2a:	6121                	addi	sp,sp,64
    4c2c:	8082                	ret
    x = -xx;
    4c2e:	40b005bb          	negw	a1,a1
    neg = 1;
    4c32:	4885                	li	a7,1
    x = -xx;
    4c34:	bf85                	j	4ba4 <printint+0x16>

0000000000004c36 <vprintf>:
}
...
{
    4c36:	711d                	addi	sp,sp,-96
    4c38:	ec86                	sd	ra,88(sp)
    4c3a:	e8a2                	sd	s0,80(sp)
    4c3c:	e0ca                	sd	s2,64(sp)
    4c3e:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4c40:	0005c903          	lbu	s2,0(a1)
    4c44:	26090863          	beqz	s2,4eb4 <vprintf+0x27e>
    4c48:	e4a6                	sd	s1,72(sp)
    4c4a:	fc4e                	sd	s3,56(sp)
    4c4c:	f852                	sd	s4,48(sp)
    4c4e:	f456                	sd	s5,40(sp)
    4c50:	f05a                	sd	s6,32(sp)
    4c52:	ec5e                	sd	s7,24(sp)
    4c54:	e862                	sd	s8,16(sp)
    4c56:	e466                	sd	s9,8(sp)
    4c58:	8b2a                	mv	s6,a0
    4c5a:	8a2e                	mv	s4,a1
    4c5c:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4c64:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4c68:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4c6c:	06c00c93          	li	s9,108
    4c70:	a005                	j	4c90 <vprintf+0x5a>
        putc(fd, c0);
    4c72:	85ca                	mv	a1,s2
    4c74:	855a                	mv	a0,s6
    4c76:	efbff0ef          	jal	4b70 <putc>
    4c7a:	a019                	j	4c80 <vprintf+0x4a>
    } else if(state == '%'){
    4c7c:	03598263          	beq	s3,s5,4ca0 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4c80:	2485                	addiw	s1,s1,1
    4c82:	8726                	mv	a4,s1
    4c84:	009a07b3          	add	a5,s4,s1
    4c88:	0007c903          	lbu	s2,0(a5)
    4c8c:	20090c63          	beqz	s2,4ea4 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
    4c90:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4c94:	fe0994e3          	bnez	s3,4c7c <vprintf+0x46>
      if(c0 == '%'){
    4c98:	fd579de3          	bne	a5,s5,4c72 <vprintf+0x3c>
        state = '%';
    4c9c:	89be                	mv	s3,a5
    4c9e:	b7cd                	j	4c80 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4ca0:	00ea06b3          	add	a3,s4,a4
    4ca4:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4ca8:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4caa:	c681                	beqz	a3,4cb2 <vprintf+0x7c>
    4cac:	9752                	add	a4,a4,s4
    4cae:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4cb2:	03878f63          	beq	a5,s8,4cf0 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
    4cb6:	05978963          	beq	a5,s9,4d08 <vprintf+0xd2>
    ...
    4cba:	07500713          	li	a4,117
    4cbe:	0ee78363          	beq	a5,a4,4da4 <vprintf+0x16e>
    ...
    4cc2:	07800713          	li	a4,120
    4cc6:	12e78563          	beq	a5,a4,4df0 <vprintf+0x1ba>
    ...
    4cca:	07000713          	li	a4,112
    4cce:	14e78a63          	beq	a5,a4,4e22 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4cd2:	07300713          	li	a4,115
    4cd6:	18e78a63          	beq	a5,a4,4e6a <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4cda:	02500713          	li	a4,37
    4cde:	04e79563          	bne	a5,a4,4d28 <vprintf+0xf2>
        putc(fd, '%');
    4ce2:	02500593          	li	a1,37
    4ce6:	855a                	mv	a0,s6
    4ce8:	e89ff0ef          	jal	4b70 <putc>
      ...
      state = 0;
    4cec:	4981                	li	s3,0
    4cee:	bf49                	j	4c80 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4cf0:	008b8913          	addi	s2,s7,8
    4cf4:	4685                	li	a3,1
    4cf6:	4629                	li	a2,10
    4cf8:	000ba583          	lw	a1,0(s7)
    4cfc:	855a                	mv	a0,s6
    4cfe:	e91ff0ef          	jal	4b8e <printint>
    4d02:	8bca                	mv	s7,s2
      state = 0;
    4d04:	4981                	li	s3,0
    4d06:	bfad                	j	4c80 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4d08:	06400793          	li	a5,100
    4d0c:	02f68963          	beq	a3,a5,4d3e <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4d10:	06c00793          	li	a5,108
    4d14:	04f68263          	beq	a3,a5,4d58 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
    4d18:	07500793          	li	a5,117
    4d1c:	0af68063          	beq	a3,a5,4dbc <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
    4d20:	07800793          	li	a5,120
    4d24:	0ef68263          	beq	a3,a5,4e08 <vprintf+0x1d2>
        putc(fd, '%');
    4d28:	02500593          	li	a1,37
    4d2c:	855a                	mv	a0,s6
    4d2e:	e43ff0ef          	jal	4b70 <putc>
        putc(fd, c0);
    4d32:	85ca                	mv	a1,s2
    4d34:	855a                	mv	a0,s6
    4d36:	e3bff0ef          	jal	4b70 <putc>
      state = 0;
    4d3a:	4981                	li	s3,0
    4d3c:	b791                	j	4c80 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4d4a:	855a                	mv	a0,s6
    4d4c:	e43ff0ef          	jal	4b8e <printint>
        i += 1;
    4d50:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d52:	8bca                	mv	s7,s2
      state = 0;
    4d54:	4981                	li	s3,0
        i += 1;
    4d56:	b72d                	j	4c80 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4d58:	06400793          	li	a5,100
    4d5c:	02f60763          	beq	a2,a5,4d8a <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4d60:	07500793          	li	a5,117
    4d64:	06f60963          	beq	a2,a5,4dd6 <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4d68:	07800793          	li	a5,120
    4d6c:	faf61ee3          	bne	a2,a5,4d28 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4d70:	008b8913          	addi	s2,s7,8
    4d74:	4681                	li	a3,0
    4d76:	4641                	li	a2,16
    4d78:	000ba583          	lw	a1,0(s7)
    4d7c:	855a                	mv	a0,s6
    4d7e:	e11ff0ef          	jal	4b8e <printint>
        i += 2;
    4d82:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4d84:	8bca                	mv	s7,s2
      state = 0;
    4d86:	4981                	li	s3,0
        i += 2;
    4d88:	bde5                	j	4c80 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4d96:	855a                	mv	a0,s6
    4d98:	df7ff0ef          	jal	4b8e <printint>
        i += 2;
    4d9c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d9e:	8bca                	mv	s7,s2
      state = 0;
    4da0:	4981                	li	s3,0
        i += 2;
    4da2:	bdf9                	j	4c80 <vprintf+0x4a>
    ...
    4db0:	855a                	mv	a0,s6
    4db2:	dddff0ef          	jal	4b8e <printint>
    4db6:	8bca                	mv	s7,s2
      state = 0;
    4db8:	4981                	li	s3,0
    4dba:	b5d9                	j	4c80 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4dbc:	008b8913          	addi	s2,s7,8
    4dc0:	4681                	li	a3,0
    4dc2:	4629                	li	a2,10
    4dc4:	000ba583          	lw	a1,0(s7)
    4dc8:	855a                	mv	a0,s6
    4dca:	dc5ff0ef          	jal	4b8e <printint>
        i += 1;
    4dce:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4dd0:	8bca                	mv	s7,s2
      state = 0;
    4dd2:	4981                	li	s3,0
        i += 1;
    4dd4:	b575                	j	4c80 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4de2:	855a                	mv	a0,s6
    4de4:	dabff0ef          	jal	4b8e <printint>
        i += 2;
    4de8:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4dea:	8bca                	mv	s7,s2
      state = 0;
    4dec:	4981                	li	s3,0
        i += 2;
    4dee:	bd49                	j	4c80 <vprintf+0x4a>
    ...
    4dfc:	855a                	mv	a0,s6
    4dfe:	d91ff0ef          	jal	4b8e <printint>
    4e02:	8bca                	mv	s7,s2
      state = 0;
    4e04:	4981                	li	s3,0
    4e06:	bdad                	j	4c80 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4e08:	008b8913          	addi	s2,s7,8
    4e0c:	4681                	li	a3,0
    4e0e:	4641                	li	a2,16
    4e10:	000ba583          	lw	a1,0(s7)
    4e14:	855a                	mv	a0,s6
    4e16:	d79ff0ef          	jal	4b8e <printint>
        i += 1;
    ...
    4e1e:	4981                	li	s3,0
        i += 1;
    4e20:	b585                	j	4c80 <vprintf+0x4a>
    4e22:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    4e24:	008b8d13          	addi	s10,s7,8
    4e28:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4e2c:	03000593          	li	a1,48
    4e30:	855a                	mv	a0,s6
    4e32:	d3fff0ef          	jal	4b70 <putc>
  putc(fd, 'x');
    4e36:	07800593          	li	a1,120
    4e3a:	855a                	mv	a0,s6
    4e3c:	d35ff0ef          	jal	4b70 <putc>
    4e40:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4e42:	00002b97          	auipc	s7,0x2
    4e46:	66eb8b93          	addi	s7,s7,1646 # 74b0 <digits>
    4e4a:	03c9d793          	srli	a5,s3,0x3c
    4e4e:	97de                	add	a5,a5,s7
    4e50:	0007c583          	lbu	a1,0(a5)
    4e54:	855a                	mv	a0,s6
    4e56:	d1bff0ef          	jal	4b70 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4e5a:	0992                	slli	s3,s3,0x4
    4e5c:	397d                	addiw	s2,s2,-1
    4e5e:	fe0916e3          	bnez	s2,4e4a <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
    4e62:	8bea                	mv	s7,s10
      state = 0;
    4e64:	4981                	li	s3,0
    4e66:	6d02                	ld	s10,0(sp)
    4e68:	bd21                	j	4c80 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    4e6a:	008b8993          	addi	s3,s7,8
    4e6e:	000bb903          	ld	s2,0(s7)
    4e72:	00090f63          	beqz	s2,4e90 <vprintf+0x25a>
        for(; *s; s++)
    4e76:	00094583          	lbu	a1,0(s2)
    4e7a:	c195                	beqz	a1,4e9e <vprintf+0x268>
          putc(fd, *s);
    4e7c:	855a                	mv	a0,s6
    4e7e:	cf3ff0ef          	jal	4b70 <putc>
        for(; *s; s++)
    4e82:	0905                	addi	s2,s2,1
    4e84:	00094583          	lbu	a1,0(s2)
    4e88:	f9f5                	bnez	a1,4e7c <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e8a:	8bce                	mv	s7,s3
      state = 0;
    4e8c:	4981                	li	s3,0
    4e8e:	bbcd                	j	4c80 <vprintf+0x4a>
          s = "(null)";
    4e90:	00002917          	auipc	s2,0x2
    4e94:	5a090913          	addi	s2,s2,1440 # 7430 <malloc+0x2494>
        for(; *s; s++)
    4e98:	02800593          	li	a1,40
    4e9c:	b7c5                	j	4e7c <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e9e:	8bce                	mv	s7,s3
      state = 0;
    4ea0:	4981                	li	s3,0
    4ea2:	bbf9                	j	4c80 <vprintf+0x4a>
    4ea4:	64a6                	ld	s1,72(sp)
    4ea6:	79e2                	ld	s3,56(sp)
    4ea8:	7a42                	ld	s4,48(sp)
    4eaa:	7aa2                	ld	s5,40(sp)
    4eac:	7b02                	ld	s6,32(sp)
    4eae:	6be2                	ld	s7,24(sp)
    4eb0:	6c42                	ld	s8,16(sp)
    4eb2:	6ca2                	ld	s9,8(sp)
    }
  }
}
    4eb4:	60e6                	ld	ra,88(sp)
    4eb6:	6446                	ld	s0,80(sp)
    4eb8:	6906                	ld	s2,64(sp)
    4eba:	6125                	addi	sp,sp,96
    4ebc:	8082                	ret

0000000000004ebe <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4ebe:	715d                	addi	sp,sp,-80
    4ec0:	ec06                	sd	ra,24(sp)
    4ec2:	e822                	sd	s0,16(sp)
    4ec4:	1000                	addi	s0,sp,32
    4ec6:	e010                	sd	a2,0(s0)
    4ec8:	e414                	sd	a3,8(s0)
    4eca:	e818                	sd	a4,16(s0)
    4ecc:	ec1c                	sd	a5,24(s0)
    4ece:	03043023          	sd	a6,32(s0)
    4ed2:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4ed6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4eda:	8622                	mv	a2,s0
    4edc:	d5bff0ef          	jal	4c36 <vprintf>
}
...
0000000000004ee8 <printf>:

void
printf(const char *fmt, ...)
{
    4ee8:	711d                	addi	sp,sp,-96
    4eea:	ec06                	sd	ra,24(sp)
    4eec:	e822                	sd	s0,16(sp)
    4eee:	1000                	addi	s0,sp,32
    4ef0:	e40c                	sd	a1,8(s0)
    4ef2:	e810                	sd	a2,16(s0)
    4ef4:	ec14                	sd	a3,24(s0)
    4ef6:	f018                	sd	a4,32(s0)
    4ef8:	f41c                	sd	a5,40(s0)
    4efa:	03043823          	sd	a6,48(s0)
    4efe:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4f02:	00840613          	addi	a2,s0,8
    4f06:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4f0a:	85aa                	mv	a1,a0
    4f0c:	4505                	li	a0,1
    4f0e:	d29ff0ef          	jal	4c36 <vprintf>
}
    4f12:	60e2                	ld	ra,24(sp)
    4f14:	6442                	ld	s0,16(sp)
    4f16:	6125                	addi	sp,sp,96
    4f18:	8082                	ret

0000000000004f1a <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    4f1c:	e422                	sd	s0,8(sp)
    4f1e:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4f20:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f24:	00004797          	auipc	a5,0x4
    4f28:	52c7b783          	ld	a5,1324(a5) # 9450 <freep>
    4f2c:	a02d                	j	4f56 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4f2e:	4618                	lw	a4,8(a2)
    4f30:	9f2d                	addw	a4,a4,a1
    4f32:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4f36:	6398                	ld	a4,0(a5)
    4f38:	6310                	ld	a2,0(a4)
    4f3a:	a83d                	j	4f78 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4f3c:	ff852703          	lw	a4,-8(a0)
    4f40:	9f31                	addw	a4,a4,a2
    4f42:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    4f44:	ff053683          	ld	a3,-16(a0)
    4f48:	a091                	j	4f8c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f4a:	6398                	ld	a4,0(a5)
    4f4c:	00e7e463          	bltu	a5,a4,4f54 <free+0x3a>
    4f50:	00e6ea63          	bltu	a3,a4,4f64 <free+0x4a>
{
    4f54:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f56:	fed7fae3          	bgeu	a5,a3,4f4a <free+0x30>
    4f5a:	6398                	ld	a4,0(a5)
    4f5c:	00e6e463          	bltu	a3,a4,4f64 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f60:	fee7eae3          	bltu	a5,a4,4f54 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    4f64:	ff852583          	lw	a1,-8(a0)
    4f68:	6390                	ld	a2,0(a5)
    4f6a:	02059813          	slli	a6,a1,0x20
    4f6e:	01c85713          	srli	a4,a6,0x1c
    4f72:	9736                	add	a4,a4,a3
    4f74:	fae60de3          	beq	a2,a4,4f2e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    4f78:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4f7c:	4790                	lw	a2,8(a5)
    4f7e:	02061593          	slli	a1,a2,0x20
    4f82:	01c5d713          	srli	a4,a1,0x1c
    4f86:	973e                	add	a4,a4,a5
    4f88:	fae68ae3          	beq	a3,a4,4f3c <free+0x22>
    p->s.ptr = bp->s.ptr;
    4f8c:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    4f8e:	00004717          	auipc	a4,0x4
    4f92:	4cf73123          	sd	a5,1218(a4) # 9450 <freep>
}
    4f96:	6422                	ld	s0,8(sp)
    4f98:	0141                	addi	sp,sp,16
    4f9a:	8082                	ret

0000000000004f9c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    4f9c:	7139                	addi	sp,sp,-64
    4f9e:	fc06                	sd	ra,56(sp)
    4fa0:	f822                	sd	s0,48(sp)
    4fa2:	f426                	sd	s1,40(sp)
    4fa4:	ec4e                	sd	s3,24(sp)
    4fa6:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4fa8:	02051493          	slli	s1,a0,0x20
    4fac:	9081                	srli	s1,s1,0x20
    4fae:	04bd                	addi	s1,s1,15
    4fb0:	8091                	srli	s1,s1,0x4
    4fb2:	0014899b          	addiw	s3,s1,1
    4fb6:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4fb8:	00004517          	auipc	a0,0x4
    4fbc:	49853503          	ld	a0,1176(a0) # 9450 <freep>
    4fc0:	c915                	beqz	a0,4ff4 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4fc2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4fc4:	4798                	lw	a4,8(a5)
    4fc6:	08977a63          	bgeu	a4,s1,505a <malloc+0xbe>
    4fca:	f04a                	sd	s2,32(sp)
    4fcc:	e852                	sd	s4,16(sp)
    4fce:	e456                	sd	s5,8(sp)
    4fd0:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    4fd2:	8a4e                	mv	s4,s3
    4fd4:	0009871b          	sext.w	a4,s3
    4fd8:	6685                	lui	a3,0x1
    4fda:	00d77363          	bgeu	a4,a3,4fe0 <malloc+0x44>
    4fde:	6a05                	lui	s4,0x1
    4fe0:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4fe4:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4fe8:	00004917          	auipc	s2,0x4
    4fec:	46890913          	addi	s2,s2,1128 # 9450 <freep>
  if(p == (char*)-1)
    4ff0:	5afd                	li	s5,-1
    4ff2:	a081                	j	5032 <malloc+0x96>
    4ff4:	f04a                	sd	s2,32(sp)
    4ff6:	e852                	sd	s4,16(sp)
    4ff8:	e456                	sd	s5,8(sp)
    4ffa:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    4ffc:	0000b797          	auipc	a5,0xb
    5000:	c7c78793          	addi	a5,a5,-900 # fc78 <base>
    5004:	00004717          	auipc	a4,0x4
    5008:	44f73623          	sd	a5,1100(a4) # 9450 <freep>
    500c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    500e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5012:	b7c1                	j	4fd2 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    5014:	6398                	ld	a4,0(a5)
    5016:	e118                	sd	a4,0(a0)
    5018:	a8a9                	j	5072 <malloc+0xd6>
  hp->s.size = nu;
    501a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    501e:	0541                	addi	a0,a0,16
    5020:	efbff0ef          	jal	4f1a <free>
  return freep;
    5024:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5028:	c12d                	beqz	a0,508a <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    502a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    502c:	4798                	lw	a4,8(a5)
    502e:	02977263          	bgeu	a4,s1,5052 <malloc+0xb6>
    if(p == freep)
    5032:	00093703          	ld	a4,0(s2)
    5036:	853e                	mv	a0,a5
    5038:	fef719e3          	bne	a4,a5,502a <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    503c:	8552                	mv	a0,s4
    503e:	acbff0ef          	jal	4b08 <sbrk>
  if(p == (char*)-1)
    5042:	fd551ce3          	bne	a0,s5,501a <malloc+0x7e>
        return 0;
    5046:	4501                	li	a0,0
    ...
    5050:	a03d                	j	507e <malloc+0xe2>
    5052:	7902                	ld	s2,32(sp)
    5054:	6a42                	ld	s4,16(sp)
    5056:	6aa2                	ld	s5,8(sp)
    5058:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    505a:	fae48de3          	beq	s1,a4,5014 <malloc+0x78>
        p->s.size -= nunits;
    505e:	4137073b          	subw	a4,a4,s3
    5062:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5064:	02071693          	slli	a3,a4,0x20
    5068:	01c6d713          	srli	a4,a3,0x1c
    506c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    506e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5072:	00004717          	auipc	a4,0x4
    5076:	3ca73f23          	sd	a0,990(a4) # 9450 <freep>
      return (void*)(p + 1);
    507a:	01078513          	addi	a0,a5,16
  }
}
    507e:	70e2                	ld	ra,56(sp)
    5080:	7442                	ld	s0,48(sp)
    5082:	74a2                	ld	s1,40(sp)
    5084:	69e2                	ld	s3,24(sp)
    5086:	6121                	addi	sp,sp,64
    5088:	8082                	ret
    508a:	7902                	ld	s2,32(sp)
    508c:	6a42                	ld	s4,16(sp)
    508e:	6aa2                	ld	s5,8(sp)
    5090:	6b02                	ld	s6,0(sp)
    5092:	b7f5                	j	507e <malloc+0xe2>
