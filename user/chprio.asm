...
user/_chprio:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
  ...
  16:	8ee58593          	addi	a1,a1,-1810 # 900 <malloc+0x106>
  1a:	4509                	li	a0,2
  1c:	700000ef          	jal	71c <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  22:	2bc000ef          	jal	2de <exit>
  26:	e426                	sd	s1,8(sp)
  28:	e04a                	sd	s2,0(sp)
  2a:	84ae                	mv	s1,a1
  }
  ...
  int pid = atoi(argv[1]);
  2c:	6588                	ld	a0,8(a1)
  2e:	1ba000ef          	jal	1e8 <atoi>
  32:	892a                	mv	s2,a0
  int priority = atoi(argv[2]);
  34:	6888                	ld	a0,16(s1)
  36:	1b2000ef          	jal	1e8 <atoi>
  3a:	84aa                	mv	s1,a0

  if (setpriority(pid, priority) < 0) {
  3c:	85aa                	mv	a1,a0
  3e:	854a                	mv	a0,s2
  40:	376000ef          	jal	3b6 <setpriority>
  44:	00054d63          	bltz	a0,5e <main+0x5e>
  ...
  50:	8f450513          	addi	a0,a0,-1804 # 940 <malloc+0x146>
  54:	6f2000ef          	jal	746 <printf>
  exit(0);
  58:	4501                	li	a0,0
  5a:	284000ef          	jal	2de <exit>
    fprintf(2, "Error: PID %d not found.\n", pid);
  5e:	864a                	mv	a2,s2
  60:	00001597          	auipc	a1,0x1
  64:	8c058593          	addi	a1,a1,-1856 # 920 <malloc+0x126>
  68:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a4:	2d0b8b93          	addi	s7,s7,720 # 970 <digits>
 ...
 6f2:	27a90913          	addi	s2,s2,634 # 968 <malloc+0x16e>
        for(; *s; s++)
