...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	0e650513          	addi	a0,a0,230 # 1170 <malloc+0x106>
      92:	325000ef          	jal	bb6 <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0da50513          	addi	a0,a0,218 # 1170 <malloc+0x106>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b2:	0ca50513          	addi	a0,a0,202 # 1178 <malloc+0x10e>
      b6:	701000ef          	jal	fb6 <printf>
    exit(1);
      ba:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      ce:	0d650513          	addi	a0,a0,214 # 11a0 <malloc+0x136>
      d2:	2ed000ef          	jal	bbe <chdir>
      d6:	00001997          	auipc	s3,0x1
      da:	0da98993          	addi	s3,s3,218 # 11b0 <malloc+0x146>
      de:	c489                	beqz	s1,e8 <go+0x74>
      e0:	00001997          	auipc	s3,0x1
      e4:	0c898993          	addi	s3,s3,200 # 11a8 <malloc+0x13e>
  uint64 iters = 0;
      e8:	4481                	li	s1,0
  int fd = -1;
      ea:	5a7d                	li	s4,-1
      ec:	00001917          	auipc	s2,0x1
      f0:	39490913          	addi	s2,s2,916 # 1480 <malloc+0x416>
    ...
    if(what == 1){
      ...
      fe:	0be50513          	addi	a0,a0,190 # 11b8 <malloc+0x14e>
    ...
    int what = myrand() % 23;
     ...
     14c:	08050513          	addi	a0,a0,128 # 11c8 <malloc+0x15e>
     ...
     15e:	05e50513          	addi	a0,a0,94 # 11b8 <malloc+0x14e>
     162:	23d000ef          	jal	b9e <unlink>
     166:	b755                	j	10a <go+0x96>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     168:	00001517          	auipc	a0,0x1
     16c:	00850513          	addi	a0,a0,8 # 1170 <malloc+0x106>
     ...
     17a:	06a50513          	addi	a0,a0,106 # 11e0 <malloc+0x176>
     17e:	221000ef          	jal	b9e <unlink>
      chdir("/");
     182:	00001517          	auipc	a0,0x1
     186:	01e50513          	addi	a0,a0,30 # 11a0 <malloc+0x136>
     18a:	235000ef          	jal	bbe <chdir>
     18e:	bfb5                	j	10a <go+0x96>
        printf("grind: chdir grindir failed\n");
     190:	00001517          	auipc	a0,0x1
     194:	fe850513          	addi	a0,a0,-24 # 1178 <malloc+0x10e>
     198:	61f000ef          	jal	fb6 <printf>
        exit(1);
     19c:	4505                	li	a0,1
     ...
     1b0:	03c50513          	addi	a0,a0,60 # 11e8 <malloc+0x17e>
     ...
     1ca:	03250513          	addi	a0,a0,50 # 11f8 <malloc+0x18e>
     ...
     2b8:	fcc50513          	addi	a0,a0,-52 # 1280 <malloc+0x216>
     2bc:	4fb000ef          	jal	fb6 <printf>
        exit(1);
     2c0:	4505                	li	a0,1
     ...
     2ea:	f9a50513          	addi	a0,a0,-102 # 1280 <malloc+0x216>
     2ee:	4c9000ef          	jal	fb6 <printf>
        exit(1);
     2f2:	4505                	li	a0,1
     ...
     32e:	f7650513          	addi	a0,a0,-138 # 12a0 <malloc+0x236>
     ...
     34e:	f4e50513          	addi	a0,a0,-178 # 1298 <malloc+0x22e>
     ...
     364:	f2050513          	addi	a0,a0,-224 # 1280 <malloc+0x216>
     368:	44f000ef          	jal	fb6 <printf>
        exit(1);
     36c:	4505                	li	a0,1
     36e:	7e0000ef          	jal	b4e <exit>
        printf("grind: chdir failed\n");
     372:	00001517          	auipc	a0,0x1
     376:	f3e50513          	addi	a0,a0,-194 # 12b0 <malloc+0x246>
     37a:	43d000ef          	jal	fb6 <printf>
        exit(1);
     37e:	4505                	li	a0,1
     ...
     3a8:	edc50513          	addi	a0,a0,-292 # 1280 <malloc+0x216>
     3ac:	40b000ef          	jal	fb6 <printf>
        exit(1);
     3b0:	4505                	li	a0,1
     ...
     3e8:	ee450513          	addi	a0,a0,-284 # 12c8 <malloc+0x25e>
     3ec:	3cb000ef          	jal	fb6 <printf>
        exit(1);
     3f0:	4505                	li	a0,1
     ...
     404:	ee058593          	addi	a1,a1,-288 # 12e0 <malloc+0x276>
     ...
     434:	eb850513          	addi	a0,a0,-328 # 12e8 <malloc+0x27e>
     438:	37f000ef          	jal	fb6 <printf>
     43c:	bfe9                	j	416 <go+0x3a2>
          printf("grind: pipe read failed\n");
     43e:	00001517          	auipc	a0,0x1
     442:	eca50513          	addi	a0,a0,-310 # 1308 <malloc+0x29e>
     446:	371000ef          	jal	fb6 <printf>
     44a:	b7c5                	j	42a <go+0x3b6>
        printf("grind: fork failed\n");
     44c:	00001517          	auipc	a0,0x1
     450:	e3450513          	addi	a0,a0,-460 # 1280 <malloc+0x216>
     454:	363000ef          	jal	fb6 <printf>
        exit(1);
     458:	4505                	li	a0,1
     ...
     4c6:	dbe50513          	addi	a0,a0,-578 # 1280 <malloc+0x216>
     4ca:	2ed000ef          	jal	fb6 <printf>
        exit(1);
     4ce:	4505                	li	a0,1
     ...
     4d8:	e5c50513          	addi	a0,a0,-420 # 1330 <malloc+0x2c6>
     ...
     4e8:	e4c50513          	addi	a0,a0,-436 # 1330 <malloc+0x2c6>
     ...
     4fc:	de858593          	addi	a1,a1,-536 # 12e0 <malloc+0x276>
     ...
     536:	dfe50513          	addi	a0,a0,-514 # 1330 <malloc+0x2c6>
     53a:	664000ef          	jal	b9e <unlink>
     53e:	b6f1                	j	10a <go+0x96>
        printf("grind: create c failed\n");
     540:	00001517          	auipc	a0,0x1
     544:	df850513          	addi	a0,a0,-520 # 1338 <malloc+0x2ce>
     548:	26f000ef          	jal	fb6 <printf>
        exit(1);
     54c:	4505                	li	a0,1
     54e:	600000ef          	jal	b4e <exit>
        printf("grind: write c failed\n");
     552:	00001517          	auipc	a0,0x1
     556:	dfe50513          	addi	a0,a0,-514 # 1350 <malloc+0x2e6>
     55a:	25d000ef          	jal	fb6 <printf>
        exit(1);
     55e:	4505                	li	a0,1
     560:	5ee000ef          	jal	b4e <exit>
        printf("grind: fstat failed\n");
     564:	00001517          	auipc	a0,0x1
     568:	e0450513          	addi	a0,a0,-508 # 1368 <malloc+0x2fe>
     56c:	24b000ef          	jal	fb6 <printf>
        exit(1);
     570:	4505                	li	a0,1
     ...
     57c:	e0850513          	addi	a0,a0,-504 # 1380 <malloc+0x316>
     580:	237000ef          	jal	fb6 <printf>
        exit(1);
     584:	4505                	li	a0,1
     586:	5c8000ef          	jal	b4e <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     58a:	00001517          	auipc	a0,0x1
     58e:	e1e50513          	addi	a0,a0,-482 # 13a8 <malloc+0x33e>
     592:	225000ef          	jal	fb6 <printf>
        exit(1);
     596:	4505                	li	a0,1
     ...
     63c:	e1058593          	addi	a1,a1,-496 # 1448 <malloc+0x3de>
     ...
     652:	c7a58593          	addi	a1,a1,-902 # 12c8 <malloc+0x25e>
     656:	4509                	li	a0,2
     658:	135000ef          	jal	f8c <fprintf>
        exit(1);
     65c:	4505                	li	a0,1
     65e:	4f0000ef          	jal	b4e <exit>
        fprintf(2, "grind: pipe failed\n");
     662:	00001597          	auipc	a1,0x1
     666:	c6658593          	addi	a1,a1,-922 # 12c8 <malloc+0x25e>
     66a:	4509                	li	a0,2
     66c:	121000ef          	jal	f8c <fprintf>
        exit(1);
     670:	4505                	li	a0,1
     ...
     6a6:	d2e58593          	addi	a1,a1,-722 # 13d0 <malloc+0x366>
     6aa:	4509                	li	a0,2
     6ac:	0e1000ef          	jal	f8c <fprintf>
          exit(1);
     6b0:	4505                	li	a0,1
     ...
     6c2:	d2a78793          	addi	a5,a5,-726 # 13e8 <malloc+0x37e>
     6c6:	f8f43c23          	sd	a5,-104(s0)
     6ca:	00001797          	auipc	a5,0x1
     6ce:	d2678793          	addi	a5,a5,-730 # 13f0 <malloc+0x386>
     6d2:	faf43023          	sd	a5,-96(s0)
     6d6:	fa043423          	sd	zero,-88(s0)
        exec("grindir/../echo", args);
     6da:	f9840593          	addi	a1,s0,-104
     6de:	00001517          	auipc	a0,0x1
     6e2:	d1a50513          	addi	a0,a0,-742 # 13f8 <malloc+0x38e>
     6e6:	4a0000ef          	jal	b86 <exec>
        fprintf(2, "grind: echo: not found\n");
     6ea:	00001597          	auipc	a1,0x1
     6ee:	d1e58593          	addi	a1,a1,-738 # 1408 <malloc+0x39e>
     6f2:	4509                	li	a0,2
     6f4:	099000ef          	jal	f8c <fprintf>
        exit(2);
     6f8:	4509                	li	a0,2
     6fa:	454000ef          	jal	b4e <exit>
        fprintf(2, "grind: fork failed\n");
     6fe:	00001597          	auipc	a1,0x1
     702:	b8258593          	addi	a1,a1,-1150 # 1280 <malloc+0x216>
     706:	4509                	li	a0,2
     708:	085000ef          	jal	f8c <fprintf>
        exit(3);
     70c:	450d                	li	a0,3
     ...
     736:	c9e58593          	addi	a1,a1,-866 # 13d0 <malloc+0x366>
     73a:	4509                	li	a0,2
     73c:	051000ef          	jal	f8c <fprintf>
          exit(4);
     740:	4511                	li	a0,4
     ...
     766:	c6e58593          	addi	a1,a1,-914 # 13d0 <malloc+0x366>
     76a:	4509                	li	a0,2
     76c:	021000ef          	jal	f8c <fprintf>
          exit(5);
     770:	4515                	li	a0,5
     ...
     782:	ca278793          	addi	a5,a5,-862 # 1420 <malloc+0x3b6>
     786:	f8f43c23          	sd	a5,-104(s0)
     78a:	fa043023          	sd	zero,-96(s0)
        exec("/cat", args);
     78e:	f9840593          	addi	a1,s0,-104
     792:	00001517          	auipc	a0,0x1
     796:	c9650513          	addi	a0,a0,-874 # 1428 <malloc+0x3be>
     79a:	3ec000ef          	jal	b86 <exec>
        fprintf(2, "grind: cat: not found\n");
     79e:	00001597          	auipc	a1,0x1
     7a2:	c9258593          	addi	a1,a1,-878 # 1430 <malloc+0x3c6>
     7a6:	4509                	li	a0,2
     7a8:	7e4000ef          	jal	f8c <fprintf>
        exit(6);
     7ac:	4519                	li	a0,6
     7ae:	3a0000ef          	jal	b4e <exit>
        fprintf(2, "grind: fork failed\n");
     7b2:	00001597          	auipc	a1,0x1
     7b6:	ace58593          	addi	a1,a1,-1330 # 1280 <malloc+0x216>
     7ba:	4509                	li	a0,2
     7bc:	7d0000ef          	jal	f8c <fprintf>
        exit(7);
     7c0:	451d                	li	a0,7
     ...
     7d4:	c8050513          	addi	a0,a0,-896 # 1450 <malloc+0x3e6>
     7d8:	7de000ef          	jal	fb6 <printf>
        exit(1);
     7dc:	4505                	li	a0,1
...
iter()
{
  ...
  unlink("a");
     ...
     7ee:	aae50513          	addi	a0,a0,-1362 # 1298 <malloc+0x22e>
     7f2:	3ac000ef          	jal	b9e <unlink>
  unlink("b");
     7f6:	00001517          	auipc	a0,0x1
     7fa:	a5250513          	addi	a0,a0,-1454 # 1248 <malloc+0x1de>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     830:	a5450513          	addi	a0,a0,-1452 # 1280 <malloc+0x216>
     834:	782000ef          	jal	fb6 <printf>
    exit(1);
     838:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     86a:	a1a50513          	addi	a0,a0,-1510 # 1280 <malloc+0x216>
     86e:	748000ef          	jal	fb6 <printf>
    exit(1);
     872:	4505                	li	a0,1
...
putc(int fd, char c)
{
     c3e:	1101                	addi	sp,sp,-32
     c40:	ec06                	sd	ra,24(sp)
     c42:	e822                	sd	s0,16(sp)
     c44:	1000                	addi	s0,sp,32
     c46:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     c4a:	4605                	li	a2,1
     c4c:	fef40593          	addi	a1,s0,-17
     c50:	f1fff0ef          	jal	b6e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     c62:	f426                	sd	s1,40(sp)
     c64:	0080                	addi	s0,sp,64
     c66:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
     c68:	c299                	beqz	a3,c6e <printint+0x12>
     c6a:	0805c963          	bltz	a1,cfc <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     c6e:	2581                	sext.w	a1,a1
  neg = 0;
     c70:	4881                	li	a7,0
     c72:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     c78:	2601                	sext.w	a2,a2
     c7a:	00001517          	auipc	a0,0x1
     c7e:	86650513          	addi	a0,a0,-1946 # 14e0 <digits>
     c82:	883a                	mv	a6,a4
     c84:	2705                	addiw	a4,a4,1
     c86:	02c5f7bb          	remuw	a5,a1,a2
     c8a:	1782                	slli	a5,a5,0x20
     c8c:	9381                	srli	a5,a5,0x20
     c8e:	97aa                	add	a5,a5,a0
     c90:	0007c783          	lbu	a5,0(a5)
     c94:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     c98:	0005879b          	sext.w	a5,a1
     c9c:	02c5d5bb          	divuw	a1,a1,a2
     ca0:	0685                	addi	a3,a3,1
     ca2:	fec7f0e3          	bgeu	a5,a2,c82 <printint+0x26>
  if(neg)
     ca6:	00088c63          	beqz	a7,cbe <printint+0x62>
    buf[i++] = '-';
     caa:	fd070793          	addi	a5,a4,-48
     cae:	00878733          	add	a4,a5,s0
     cb2:	02d00793          	li	a5,45
     cb6:	fef70823          	sb	a5,-16(a4)
     cba:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     cbe:	02e05a63          	blez	a4,cf2 <printint+0x96>
     cc2:	f04a                	sd	s2,32(sp)
     cc4:	ec4e                	sd	s3,24(sp)
     cc6:	fc040793          	addi	a5,s0,-64
     cca:	00e78933          	add	s2,a5,a4
     cce:	fff78993          	addi	s3,a5,-1
     cd2:	99ba                	add	s3,s3,a4
     cd4:	377d                	addiw	a4,a4,-1
     cd6:	1702                	slli	a4,a4,0x20
     cd8:	9301                	srli	a4,a4,0x20
     cda:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     cde:	fff94583          	lbu	a1,-1(s2)
     ce2:	8526                	mv	a0,s1
     ce4:	f5bff0ef          	jal	c3e <putc>
  while(--i >= 0)
     ce8:	197d                	addi	s2,s2,-1
     cea:	ff391ae3          	bne	s2,s3,cde <printint+0x82>
     ...
     cfa:	8082                	ret
    x = -xx;
     cfc:	40b005bb          	negw	a1,a1
    neg = 1;
     d00:	4885                	li	a7,1
    x = -xx;
     d02:	bf85                	j	c72 <printint+0x16>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     d12:	26090863          	beqz	s2,f82 <vprintf+0x27e>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     d5a:	20090c63          	beqz	s2,f72 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
    ...
    if(state == 0){
     ...
     d7c:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     d80:	03878f63          	beq	a5,s8,dbe <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
     d84:	05978963          	beq	a5,s9,dd6 <vprintf+0xd2>
     ...
     d8c:	0ee78363          	beq	a5,a4,e72 <vprintf+0x16e>
     ...
     d94:	12e78563          	beq	a5,a4,ebe <vprintf+0x1ba>
     ...
     d9c:	14e78a63          	beq	a5,a4,ef0 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     da0:	07300713          	li	a4,115
     da4:	18e78a63          	beq	a5,a4,f38 <vprintf+0x234>
     ...
     dac:	04e79563          	bne	a5,a4,df6 <vprintf+0xf2>
        putc(fd, '%');
     db0:	02500593          	li	a1,37
     db4:	855a                	mv	a0,s6
     db6:	e89ff0ef          	jal	c3e <putc>
     ...
     dca:	855a                	mv	a0,s6
     dcc:	e91ff0ef          	jal	c5c <printint>
     dd0:	8bca                	mv	s7,s2
      state = 0;
     dd2:	4981                	li	s3,0
     dd4:	bfad                	j	d4e <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     dd6:	06400793          	li	a5,100
     dda:	02f68963          	beq	a3,a5,e0c <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     dde:	06c00793          	li	a5,108
     de2:	04f68263          	beq	a3,a5,e26 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
     de6:	07500793          	li	a5,117
     dea:	0af68063          	beq	a3,a5,e8a <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
     dee:	07800793          	li	a5,120
     df2:	0ef68263          	beq	a3,a5,ed6 <vprintf+0x1d2>
        putc(fd, '%');
     df6:	02500593          	li	a1,37
     dfa:	855a                	mv	a0,s6
     dfc:	e43ff0ef          	jal	c3e <putc>
        putc(fd, c0);
     e00:	85ca                	mv	a1,s2
     e02:	855a                	mv	a0,s6
     e04:	e3bff0ef          	jal	c3e <putc>
      state = 0;
     e08:	4981                	li	s3,0
     e0a:	b791                	j	d4e <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     e0c:	008b8913          	addi	s2,s7,8
     e10:	4685                	li	a3,1
     e12:	4629                	li	a2,10
     e14:	000ba583          	lw	a1,0(s7)
     e18:	855a                	mv	a0,s6
     e1a:	e43ff0ef          	jal	c5c <printint>
        i += 1;
     ...
     e22:	4981                	li	s3,0
        i += 1;
     e24:	b72d                	j	d4e <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e26:	06400793          	li	a5,100
     e2a:	02f60763          	beq	a2,a5,e58 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     e2e:	07500793          	li	a5,117
     e32:	06f60963          	beq	a2,a5,ea4 <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     e36:	07800793          	li	a5,120
     e3a:	faf61ee3          	bne	a2,a5,df6 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     e7e:	855a                	mv	a0,s6
     e80:	dddff0ef          	jal	c5c <printint>
     e84:	8bca                	mv	s7,s2
      state = 0;
     e86:	4981                	li	s3,0
     e88:	b5d9                	j	d4e <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     eca:	855a                	mv	a0,s6
     ecc:	d91ff0ef          	jal	c5c <printint>
     ed0:	8bca                	mv	s7,s2
      state = 0;
     ed2:	4981                	li	s3,0
     ed4:	bdad                	j	d4e <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
  ...
  putc(fd, '0');
     ...
     efe:	855a                	mv	a0,s6
     f00:	d3fff0ef          	jal	c3e <putc>
  putc(fd, 'x');
     f04:	07800593          	li	a1,120
     f08:	855a                	mv	a0,s6
     f0a:	d35ff0ef          	jal	c3e <putc>
     f0e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f10:	00000b97          	auipc	s7,0x0
     f14:	5d0b8b93          	addi	s7,s7,1488 # 14e0 <digits>
     f18:	03c9d793          	srli	a5,s3,0x3c
     f1c:	97de                	add	a5,a5,s7
     f1e:	0007c583          	lbu	a1,0(a5)
     f22:	855a                	mv	a0,s6
     f24:	d1bff0ef          	jal	c3e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     f28:	0992                	slli	s3,s3,0x4
     f2a:	397d                	addiw	s2,s2,-1
     f2c:	fe0916e3          	bnez	s2,f18 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
     f30:	8bea                	mv	s7,s10
      state = 0;
     f32:	4981                	li	s3,0
     f34:	6d02                	ld	s10,0(sp)
     f36:	bd21                	j	d4e <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     f38:	008b8993          	addi	s3,s7,8
     f3c:	000bb903          	ld	s2,0(s7)
     f40:	00090f63          	beqz	s2,f5e <vprintf+0x25a>
        for(; *s; s++)
     f44:	00094583          	lbu	a1,0(s2)
     f48:	c195                	beqz	a1,f6c <vprintf+0x268>
          putc(fd, *s);
     f4a:	855a                	mv	a0,s6
     f4c:	cf3ff0ef          	jal	c3e <putc>
        for(; *s; s++)
     f50:	0905                	addi	s2,s2,1
     f52:	00094583          	lbu	a1,0(s2)
     f56:	f9f5                	bnez	a1,f4a <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     f58:	8bce                	mv	s7,s3
      state = 0;
     f5a:	4981                	li	s3,0
     f5c:	bbcd                	j	d4e <vprintf+0x4a>
          s = "(null)";
     f5e:	00000917          	auipc	s2,0x0
     f62:	51a90913          	addi	s2,s2,1306 # 1478 <malloc+0x40e>
        for(; *s; s++)
     f66:	02800593          	li	a1,40
     f6a:	b7c5                	j	f4a <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     f6c:	8bce                	mv	s7,s3
      state = 0;
     f6e:	4981                	li	s3,0
     f70:	bbf9                	j	d4e <vprintf+0x4a>
     f72:	64a6                	ld	s1,72(sp)
     f74:	79e2                	ld	s3,56(sp)
     f76:	7a42                	ld	s4,48(sp)
     f78:	7aa2                	ld	s5,40(sp)
     f7a:	7b02                	ld	s6,32(sp)
     f7c:	6be2                	ld	s7,24(sp)
     f7e:	6c42                	ld	s8,16(sp)
     f80:	6ca2                	ld	s9,8(sp)
    }
  }
}
     f82:	60e6                	ld	ra,88(sp)
     f84:	6446                	ld	s0,80(sp)
     f86:	6906                	ld	s2,64(sp)
     f88:	6125                	addi	sp,sp,96
     f8a:	8082                	ret
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ffa:	a02d                	j	1024 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
     ffc:	4618                	lw	a4,8(a2)
     ffe:	9f2d                	addw	a4,a4,a1
    1000:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1004:	6398                	ld	a4,0(a5)
    1006:	6310                	ld	a2,0(a4)
    1008:	a83d                	j	1046 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    100a:	ff852703          	lw	a4,-8(a0)
    100e:	9f31                	addw	a4,a4,a2
    1010:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1012:	ff053683          	ld	a3,-16(a0)
    1016:	a091                	j	105a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1018:	6398                	ld	a4,0(a5)
    101a:	00e7e463          	bltu	a5,a4,1022 <free+0x3a>
    101e:	00e6ea63          	bltu	a3,a4,1032 <free+0x4a>
{
    1022:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1024:	fed7fae3          	bgeu	a5,a3,1018 <free+0x30>
    1028:	6398                	ld	a4,0(a5)
    102a:	00e6e463          	bltu	a3,a4,1032 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    102e:	fee7eae3          	bltu	a5,a4,1022 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1032:	ff852583          	lw	a1,-8(a0)
    1036:	6390                	ld	a2,0(a5)
    1038:	02059813          	slli	a6,a1,0x20
    103c:	01c85713          	srli	a4,a6,0x1c
    1040:	9736                	add	a4,a4,a3
    1042:	fae60de3          	beq	a2,a4,ffc <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1046:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    104a:	4790                	lw	a2,8(a5)
    104c:	02061593          	slli	a1,a2,0x20
    1050:	01c5d713          	srli	a4,a1,0x1c
    1054:	973e                	add	a4,a4,a5
    1056:	fae68ae3          	beq	a3,a4,100a <free+0x22>
    p->s.ptr = bp->s.ptr;
    105a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    ...
    1064:	6422                	ld	s0,8(sp)
    1066:	0141                	addi	sp,sp,16
    1068:	8082                	ret

000000000000106a <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    106a:	7139                	addi	sp,sp,-64
    106c:	fc06                	sd	ra,56(sp)
    106e:	f822                	sd	s0,48(sp)
    1070:	f426                	sd	s1,40(sp)
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1076:	02051493          	slli	s1,a0,0x20
    107a:	9081                	srli	s1,s1,0x20
    107c:	04bd                	addi	s1,s1,15
    107e:	8091                	srli	s1,s1,0x4
    1080:	0014899b          	addiw	s3,s1,1
    1084:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1086:	00001517          	auipc	a0,0x1
    108a:	f8a53503          	ld	a0,-118(a0) # 2010 <freep>
    108e:	c915                	beqz	a0,10c2 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1090:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1092:	4798                	lw	a4,8(a5)
    1094:	08977a63          	bgeu	a4,s1,1128 <malloc+0xbe>
  ...
  if(nu < 4096)
    10a0:	8a4e                	mv	s4,s3
    10a2:	0009871b          	sext.w	a4,s3
    10a6:	6685                	lui	a3,0x1
    10a8:	00d77363          	bgeu	a4,a3,10ae <malloc+0x44>
    10ac:	6a05                	lui	s4,0x1
    10ae:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    10b2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    10b6:	00001917          	auipc	s2,0x1
    10ba:	f5a90913          	addi	s2,s2,-166 # 2010 <freep>
  if(p == (char*)-1)
    10be:	5afd                	li	s5,-1
    10c0:	a081                	j	1100 <malloc+0x96>
    10c2:	f04a                	sd	s2,32(sp)
    10c4:	e852                	sd	s4,16(sp)
    10c6:	e456                	sd	s5,8(sp)
    10c8:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    10ca:	00001797          	auipc	a5,0x1
    10ce:	33e78793          	addi	a5,a5,830 # 2408 <base>
    10d2:	00001717          	auipc	a4,0x1
    10d6:	f2f73f23          	sd	a5,-194(a4) # 2010 <freep>
    10da:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    10dc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    10e0:	b7c1                	j	10a0 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    10e2:	6398                	ld	a4,0(a5)
    10e4:	e118                	sd	a4,0(a0)
    10e6:	a8a9                	j	1140 <malloc+0xd6>
  hp->s.size = nu;
    10e8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    10ec:	0541                	addi	a0,a0,16
    10ee:	efbff0ef          	jal	fe8 <free>
  return freep;
    10f2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    10f6:	c12d                	beqz	a0,1158 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    10fa:	4798                	lw	a4,8(a5)
    10fc:	02977263          	bgeu	a4,s1,1120 <malloc+0xb6>
    if(p == freep)
    1100:	00093703          	ld	a4,0(s2)
    1104:	853e                	mv	a0,a5
    1106:	fef719e3          	bne	a4,a5,10f8 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    110a:	8552                	mv	a0,s4
    110c:	acbff0ef          	jal	bd6 <sbrk>
  if(p == (char*)-1)
    1110:	fd551ce3          	bne	a0,s5,10e8 <malloc+0x7e>
        return 0;
    1114:	4501                	li	a0,0
    1116:	7902                	ld	s2,32(sp)
    1118:	6a42                	ld	s4,16(sp)
    111a:	6aa2                	ld	s5,8(sp)
    111c:	6b02                	ld	s6,0(sp)
    111e:	a03d                	j	114c <malloc+0xe2>
    1120:	7902                	ld	s2,32(sp)
    1122:	6a42                	ld	s4,16(sp)
    1124:	6aa2                	ld	s5,8(sp)
    1126:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1128:	fae48de3          	beq	s1,a4,10e2 <malloc+0x78>
        p->s.size -= nunits;
    112c:	4137073b          	subw	a4,a4,s3
    1130:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1132:	02071693          	slli	a3,a4,0x20
    1136:	01c6d713          	srli	a4,a3,0x1c
    113a:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    113c:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1140:	00001717          	auipc	a4,0x1
    1144:	eca73823          	sd	a0,-304(a4) # 2010 <freep>
      return (void*)(p + 1);
    1148:	01078513          	addi	a0,a5,16
  }
}
    114c:	70e2                	ld	ra,56(sp)
    114e:	7442                	ld	s0,48(sp)
    1150:	74a2                	ld	s1,40(sp)
