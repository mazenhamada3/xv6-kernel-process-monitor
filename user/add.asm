...
int main(int argc, char *argv[]) {
   ...
   6:	1000                	addi	s0,sp,32
    if (argc != 3) {
   8:	478d                	li	a5,3
   a:	02f51f63          	bne	a0,a5,48 <main+0x48>
   e:	e426                	sd	s1,8(sp)
  10:	84ae                	mv	s1,a1
  ...
  1c:	04f70263          	beq	a4,a5,60 <main+0x60>
  20:	e04a                	sd	s2,0(sp)
  ...
  22:	1d2000ef          	jal	1f4 <atoi>
  26:	892a                	mv	s2,a0
    int num2 = atoi(argv[2]);
  28:	6888                	ld	a0,16(s1)
  2a:	1ca000ef          	jal	1f4 <atoi>
  2e:	862a                	mv	a2,a0
    int result = num1 + num2;

    printf("%d + %d = %d\n", num1, num2, result);
  30:	00a906bb          	addw	a3,s2,a0
  34:	85ca                	mv	a1,s2
  36:	00001517          	auipc	a0,0x1
  3a:	91250513          	addi	a0,a0,-1774 # 948 <malloc+0x142>
  3e:	714000ef          	jal	752 <printf>
    exit(0);
  42:	4501                	li	a0,0
  44:	2a6000ef          	jal	2ea <exit>
  48:	e426                	sd	s1,8(sp)
  4a:	e04a                	sd	s2,0(sp)
        fprintf(2, "Usage: add number1 number2\n");
  4c:	00001597          	auipc	a1,0x1
  50:	8b458593          	addi	a1,a1,-1868 # 900 <malloc+0xfa>
  54:	4509                	li	a0,2
  56:	6d2000ef          	jal	728 <fprintf>
        exit(1);
  5a:	4505                	li	a0,1
  5c:	28e000ef          	jal	2ea <exit>
  60:	e04a                	sd	s2,0(sp)
        printf("Usage: add number1 number2\n");
  62:	00001517          	auipc	a0,0x1
  66:	89e50513          	addi	a0,a0,-1890 # 900 <malloc+0xfa>
  6a:	6e8000ef          	jal	752 <printf>
        printf("Add two integers and print the result\n");
  6e:	00001517          	auipc	a0,0x1
  72:	8b250513          	addi	a0,a0,-1870 # 920 <malloc+0x11a>
  76:	6dc000ef          	jal	752 <printf>
        exit(0);
  7a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	54a50513          	addi	a0,a0,1354 # 960 <digits>
 41e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6b0:	2b4b8b93          	addi	s7,s7,692 # 960 <digits>
 ...
 6fe:	25e90913          	addi	s2,s2,606 # 958 <malloc+0x152>
        for(; *s; s++)
