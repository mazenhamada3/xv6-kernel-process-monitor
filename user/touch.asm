...
int main(int argc, char *argv[]) {
   ...
   6:	1000                	addi	s0,sp,32
    if (argc != 2) {
   8:	4789                	li	a5,2
   a:	02f51663          	bne	a0,a5,36 <main+0x36>
   e:	e426                	sd	s1,8(sp)
  10:	84ae                	mv	s1,a1
  ...
  1c:	02f70863          	beq	a4,a5,4c <main+0x4c>
  ...
  20:	20200593          	li	a1,514
  24:	306000ef          	jal	32a <open>
    if (fd < 0) {
  28:	04054163          	bltz	a0,6a <main+0x6a>
        fprintf(2, "touch: cannot create %s\n", argv[1]);
        exit(1);
    }

    close(fd);
  2c:	2e6000ef          	jal	312 <close>
    exit(0);
  30:	4501                	li	a0,0
  32:	2b8000ef          	jal	2ea <exit>
  36:	e426                	sd	s1,8(sp)
        fprintf(2, "Usage: touch filename\n");
  38:	00001597          	auipc	a1,0x1
  3c:	8c858593          	addi	a1,a1,-1848 # 900 <malloc+0xfa>
  40:	4509                	li	a0,2
  42:	6e6000ef          	jal	728 <fprintf>
        exit(1);
  46:	4505                	li	a0,1
  48:	2a2000ef          	jal	2ea <exit>
        printf("Usage: touch filename\n");
  4c:	00001517          	auipc	a0,0x1
  50:	8b450513          	addi	a0,a0,-1868 # 900 <malloc+0xfa>
  54:	6fe000ef          	jal	752 <printf>
        printf("Create an empty file if it doesn't exist\n");
  58:	00001517          	auipc	a0,0x1
  5c:	8c850513          	addi	a0,a0,-1848 # 920 <malloc+0x11a>
  60:	6f2000ef          	jal	752 <printf>
        exit(0);
  64:	4501                	li	a0,0
  66:	284000ef          	jal	2ea <exit>
        fprintf(2, "touch: cannot create %s\n", argv[1]);
  6a:	6490                	ld	a2,8(s1)
  6c:	00001597          	auipc	a1,0x1
  70:	8e458593          	addi	a1,a1,-1820 # 950 <malloc+0x14a>
  74:	4509                	li	a0,2
  76:	6b2000ef          	jal	728 <fprintf>
        exit(1);
  7a:	4505                	li	a0,1
  7c:	26e000ef          	jal	2ea <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	56250513          	addi	a0,a0,1378 # 978 <digits>
 41e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6b0:	2ccb8b93          	addi	s7,s7,716 # 978 <digits>
 ...
 6fe:	27690913          	addi	s2,s2,630 # 970 <malloc+0x16a>
        for(; *s; s++)
