...
printint(int fd, int xx, int base, int sgn)
{
 ...
 400:	53450513          	addi	a0,a0,1332 # 930 <digits>
 404:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 494:	26090863          	beqz	s2,704 <vprintf+0x27e>
 ...
 4dc:	20090c63          	beqz	s2,6f4 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
 ...
 4fe:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 502:	03878f63          	beq	a5,s8,540 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
 506:	05978963          	beq	a5,s9,558 <vprintf+0xd2>
 ...
 50e:	0ee78363          	beq	a5,a4,5f4 <vprintf+0x16e>
 ...
 516:	12e78563          	beq	a5,a4,640 <vprintf+0x1ba>
 ...
 51e:	14e78a63          	beq	a5,a4,672 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
 522:	07300713          	li	a4,115
 526:	18e78a63          	beq	a5,a4,6ba <vprintf+0x234>
 ...
 52e:	04e79563          	bne	a5,a4,578 <vprintf+0xf2>
        putc(fd, '%');
 532:	02500593          	li	a1,37
 536:	855a                	mv	a0,s6
 538:	e89ff0ef          	jal	3c0 <putc>
 ...
 680:	855a                	mv	a0,s6
 682:	d3fff0ef          	jal	3c0 <putc>
  putc(fd, 'x');
 686:	07800593          	li	a1,120
 68a:	855a                	mv	a0,s6
 68c:	d35ff0ef          	jal	3c0 <putc>
 690:	4941                	li	s2,16
 ...
 6a4:	855a                	mv	a0,s6
 6a6:	d1bff0ef          	jal	3c0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6aa:	0992                	slli	s3,s3,0x4
 6ac:	397d                	addiw	s2,s2,-1
 6ae:	fe0916e3          	bnez	s2,69a <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
 6b2:	8bea                	mv	s7,s10
      state = 0;
 6b4:	4981                	li	s3,0
 6b6:	6d02                	ld	s10,0(sp)
 6b8:	bd21                	j	4d0 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 6ba:	008b8993          	addi	s3,s7,8
 6be:	000bb903          	ld	s2,0(s7)
 6c2:	00090f63          	beqz	s2,6e0 <vprintf+0x25a>
        for(; *s; s++)
 6c6:	00094583          	lbu	a1,0(s2)
 6ca:	c195                	beqz	a1,6ee <vprintf+0x268>
          putc(fd, *s);
 6cc:	855a                	mv	a0,s6
 6ce:	cf3ff0ef          	jal	3c0 <putc>
        for(; *s; s++)
 6d2:	0905                	addi	s2,s2,1
 6d4:	00094583          	lbu	a1,0(s2)
 6d8:	f9f5                	bnez	a1,6cc <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
 6da:	8bce                	mv	s7,s3
      state = 0;
 6dc:	4981                	li	s3,0
 6de:	bbcd                	j	4d0 <vprintf+0x4a>
          s = "(null)";
 6e0:	00000917          	auipc	s2,0x0
 6e4:	24890913          	addi	s2,s2,584 # 928 <malloc+0x13c>
        for(; *s; s++)
 6e8:	02800593          	li	a1,40
 6ec:	b7c5                	j	6cc <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
 6ee:	8bce                	mv	s7,s3
      state = 0;
 6f0:	4981                	li	s3,0
 6f2:	bbf9                	j	4d0 <vprintf+0x4a>
