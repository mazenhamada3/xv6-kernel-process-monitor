...
int main(void)
{
   ...
   6:	0800                	addi	s0,sp,16
    printf("Random: %d\n", rand());
   8:	33a000ef          	jal	342 <rand>
   c:	85aa                	mv	a1,a0
   e:	00001517          	auipc	a0,0x1
  12:	89250513          	addi	a0,a0,-1902 # 8a0 <malloc+0xfa>
  16:	6dc000ef          	jal	6f2 <printf>
    exit(0);
  1a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	50250513          	addi	a0,a0,1282 # 8b8 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 650:	26cb8b93          	addi	s7,s7,620 # 8b8 <digits>
 ...
 69e:	21690913          	addi	s2,s2,534 # 8b0 <malloc+0x10a>
        for(; *s; s++)
