...
int main()
{
   ...
   c:	376000ef          	jal	382 <datetime>
  10:	02054763          	bltz	a0,3e <main+0x3e>
        printf("Failed to get datetime\n");
        exit(1);
    }

    printf("Current Date and Time: %d-%d-%d %d:%d:%d\n",
  14:	fe442803          	lw	a6,-28(s0)
  18:	fe042783          	lw	a5,-32(s0)
  1c:	fdc42703          	lw	a4,-36(s0)
  20:	fd842683          	lw	a3,-40(s0)
  24:	fd442603          	lw	a2,-44(s0)
  28:	fd042583          	lw	a1,-48(s0)
  2c:	00001517          	auipc	a0,0x1
  30:	8bc50513          	addi	a0,a0,-1860 # 8e8 <malloc+0x112>
  34:	6ee000ef          	jal	722 <printf>
           dt.year, dt.month, dt.day, dt.hour, dt.minute, dt.second);

    exit(0);
  38:	4501                	li	a0,0
  3a:	280000ef          	jal	2ba <exit>
        printf("Failed to get datetime\n");
  3e:	00001517          	auipc	a0,0x1
  42:	89250513          	addi	a0,a0,-1902 # 8d0 <malloc+0xfa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ea:	53a50513          	addi	a0,a0,1338 # 920 <digits>
 3ee:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 680:	2a4b8b93          	addi	s7,s7,676 # 920 <digits>
 ...
 6ce:	24e90913          	addi	s2,s2,590 # 918 <malloc+0x142>
        for(; *s; s++)
