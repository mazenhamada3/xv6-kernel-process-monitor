...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8d6:	a3648493          	addi	s1,s1,-1482 # 1308 <malloc+0x1f0>
     8da:	4589                	li	a1,2
     8dc:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     970:	9a458593          	addi	a1,a1,-1628 # 1310 <malloc+0x1f8>
     974:	4509                	li	a0,2
     976:	6c4000ef          	jal	103a <fprintf>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     d16:	c299                	beqz	a3,d1c <printint+0x12>
     d18:	0805c963          	bltz	a1,daa <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     d1c:	2581                	sext.w	a1,a1
  neg = 0;
     d1e:	4881                	li	a7,0
     d20:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     d26:	2601                	sext.w	a2,a2
     d28:	00000517          	auipc	a0,0x0
     d2c:	63050513          	addi	a0,a0,1584 # 1358 <digits>
     d30:	883a                	mv	a6,a4
     d32:	2705                	addiw	a4,a4,1
     d34:	02c5f7bb          	remuw	a5,a1,a2
     d38:	1782                	slli	a5,a5,0x20
     d3a:	9381                	srli	a5,a5,0x20
     d3c:	97aa                	add	a5,a5,a0
     d3e:	0007c783          	lbu	a5,0(a5)
     d42:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     d46:	0005879b          	sext.w	a5,a1
     d4a:	02c5d5bb          	divuw	a1,a1,a2
     d4e:	0685                	addi	a3,a3,1
     d50:	fec7f0e3          	bgeu	a5,a2,d30 <printint+0x26>
  if(neg)
     d54:	00088c63          	beqz	a7,d6c <printint+0x62>
    buf[i++] = '-';
     d58:	fd070793          	addi	a5,a4,-48
     d5c:	00878733          	add	a4,a5,s0
     d60:	02d00793          	li	a5,45
     d64:	fef70823          	sb	a5,-16(a4)
     d68:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     d6c:	02e05a63          	blez	a4,da0 <printint+0x96>
     d70:	f04a                	sd	s2,32(sp)
     d72:	ec4e                	sd	s3,24(sp)
     d74:	fc040793          	addi	a5,s0,-64
     d78:	00e78933          	add	s2,a5,a4
     d7c:	fff78993          	addi	s3,a5,-1
    ...
    putc(fd, buf[i]);
     d8c:	fff94583          	lbu	a1,-1(s2)
     d90:	8526                	mv	a0,s1
     d92:	f5bff0ef          	jal	cec <putc>
  while(--i >= 0)
     d96:	197d                	addi	s2,s2,-1
     d98:	ff391ae3          	bne	s2,s3,d8c <printint+0x82>
     d9c:	7902                	ld	s2,32(sp)
     d9e:	69e2                	ld	s3,24(sp)
}
     da0:	70e2                	ld	ra,56(sp)
     da2:	7442                	ld	s0,48(sp)
     da4:	74a2                	ld	s1,40(sp)
     da6:	6121                	addi	sp,sp,64
     da8:	8082                	ret
    x = -xx;
     daa:	40b005bb          	negw	a1,a1
    neg = 1;
     dae:	4885                	li	a7,1
    x = -xx;
     db0:	bf85                	j	d20 <printint+0x16>

0000000000000db2 <vprintf>:
}
...
{
     db2:	711d                	addi	sp,sp,-96
     db4:	ec86                	sd	ra,88(sp)
     db6:	e8a2                	sd	s0,80(sp)
     db8:	e0ca                	sd	s2,64(sp)
     dba:	1080                	addi	s0,sp,96
  char *s;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dc0:	26090863          	beqz	s2,1030 <vprintf+0x27e>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dec:	a005                	j	e0c <vprintf+0x5a>
        putc(fd, c0);
     dee:	85ca                	mv	a1,s2
     df0:	855a                	mv	a0,s6
     df2:	efbff0ef          	jal	cec <putc>
     df6:	a019                	j	dfc <vprintf+0x4a>
    } else if(state == '%'){
     df8:	03598263          	beq	s3,s5,e1c <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     dfc:	2485                	addiw	s1,s1,1
     dfe:	8726                	mv	a4,s1
     e00:	009a07b3          	add	a5,s4,s1
     e04:	0007c903          	lbu	s2,0(a5)
     e08:	20090c63          	beqz	s2,1020 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
     e0c:	0009079b          	sext.w	a5,s2
    if(state == 0){
     e10:	fe0994e3          	bnez	s3,df8 <vprintf+0x46>
      if(c0 == '%'){
     e14:	fd579de3          	bne	a5,s5,dee <vprintf+0x3c>
        state = '%';
     e18:	89be                	mv	s3,a5
     e1a:	b7cd                	j	dfc <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     e1c:	00ea06b3          	add	a3,s4,a4
     e20:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     e24:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e26:	c681                	beqz	a3,e2e <vprintf+0x7c>
     e28:	9752                	add	a4,a4,s4
     e2a:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e2e:	03878f63          	beq	a5,s8,e6c <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
     e32:	05978963          	beq	a5,s9,e84 <vprintf+0xd2>
     ...
     e36:	07500713          	li	a4,117
     e3a:	0ee78363          	beq	a5,a4,f20 <vprintf+0x16e>
     ...
     e42:	12e78563          	beq	a5,a4,f6c <vprintf+0x1ba>
     ...
     e4a:	14e78a63          	beq	a5,a4,f9e <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     e4e:	07300713          	li	a4,115
     e52:	18e78a63          	beq	a5,a4,fe6 <vprintf+0x234>
     ...
     e5a:	04e79563          	bne	a5,a4,ea4 <vprintf+0xf2>
        putc(fd, '%');
     ...
     e7e:	8bca                	mv	s7,s2
      state = 0;
     e80:	4981                	li	s3,0
     e82:	bfad                	j	dfc <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     e84:	06400793          	li	a5,100
     e88:	02f68963          	beq	a3,a5,eba <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e8c:	06c00793          	li	a5,108
     e90:	04f68263          	beq	a3,a5,ed4 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
     e94:	07500793          	li	a5,117
     e98:	0af68063          	beq	a3,a5,f38 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
     e9c:	07800793          	li	a5,120
     ea0:	0ef68263          	beq	a3,a5,f84 <vprintf+0x1d2>
        putc(fd, '%');
     ...
     ec8:	e43ff0ef          	jal	d0a <printint>
        i += 1;
     ecc:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
     ece:	8bca                	mv	s7,s2
      state = 0;
     ed0:	4981                	li	s3,0
        i += 1;
     ed2:	b72d                	j	dfc <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     ed4:	06400793          	li	a5,100
     ed8:	02f60763          	beq	a2,a5,f06 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     edc:	07500793          	li	a5,117
     ee0:	06f60963          	beq	a2,a5,f52 <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     ee4:	07800793          	li	a5,120
     ee8:	faf61ee3          	bne	a2,a5,ea4 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f14:	df7ff0ef          	jal	d0a <printint>
        i += 2;
     f18:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
     f1a:	8bca                	mv	s7,s2
      state = 0;
     f1c:	4981                	li	s3,0
        i += 2;
     f1e:	bdf9                	j	dfc <vprintf+0x4a>
     ...
     f46:	dc5ff0ef          	jal	d0a <printint>
        i += 1;
     f4a:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
     f4c:	8bca                	mv	s7,s2
      state = 0;
     f4e:	4981                	li	s3,0
        i += 1;
     f50:	b575                	j	dfc <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     f52:	008b8913          	addi	s2,s7,8
     f56:	4681                	li	a3,0
     f58:	4629                	li	a2,10
     f5a:	000ba583          	lw	a1,0(s7)
     f5e:	855a                	mv	a0,s6
     f60:	dabff0ef          	jal	d0a <printint>
        i += 2;
     f64:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
     f66:	8bca                	mv	s7,s2
      state = 0;
     f68:	4981                	li	s3,0
        i += 2;
     f6a:	bd49                	j	dfc <vprintf+0x4a>
     ...
     f7e:	8bca                	mv	s7,s2
      state = 0;
     f80:	4981                	li	s3,0
     f82:	bdad                	j	dfc <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     f84:	008b8913          	addi	s2,s7,8
     f88:	4681                	li	a3,0
     f8a:	4641                	li	a2,16
     ...
     f92:	d79ff0ef          	jal	d0a <printint>
        i += 1;
     f96:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
     f98:	8bca                	mv	s7,s2
      state = 0;
     f9a:	4981                	li	s3,0
        i += 1;
     f9c:	b585                	j	dfc <vprintf+0x4a>
     f9e:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
     fa0:	008b8d13          	addi	s10,s7,8
  ...
  putc(fd, 'x');
     ...
     fb6:	855a                	mv	a0,s6
     fb8:	d35ff0ef          	jal	cec <putc>
     fbc:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fbe:	00000b97          	auipc	s7,0x0
     fc2:	39ab8b93          	addi	s7,s7,922 # 1358 <digits>
     fc6:	03c9d793          	srli	a5,s3,0x3c
     fca:	97de                	add	a5,a5,s7
     fcc:	0007c583          	lbu	a1,0(a5)
     fd0:	855a                	mv	a0,s6
     fd2:	d1bff0ef          	jal	cec <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fd6:	0992                	slli	s3,s3,0x4
     fd8:	397d                	addiw	s2,s2,-1
     fda:	fe0916e3          	bnez	s2,fc6 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
     fde:	8bea                	mv	s7,s10
      state = 0;
     fe0:	4981                	li	s3,0
     fe2:	6d02                	ld	s10,0(sp)
     fe4:	bd21                	j	dfc <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     fe6:	008b8993          	addi	s3,s7,8
     fea:	000bb903          	ld	s2,0(s7)
     fee:	00090f63          	beqz	s2,100c <vprintf+0x25a>
        for(; *s; s++)
     ff2:	00094583          	lbu	a1,0(s2)
     ff6:	c195                	beqz	a1,101a <vprintf+0x268>
          putc(fd, *s);
     ff8:	855a                	mv	a0,s6
     ffa:	cf3ff0ef          	jal	cec <putc>
        for(; *s; s++)
     ffe:	0905                	addi	s2,s2,1
    1000:	00094583          	lbu	a1,0(s2)
    1004:	f9f5                	bnez	a1,ff8 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    1006:	8bce                	mv	s7,s3
      state = 0;
    1008:	4981                	li	s3,0
    100a:	bbcd                	j	dfc <vprintf+0x4a>
          s = "(null)";
    100c:	00000917          	auipc	s2,0x0
    1010:	31490913          	addi	s2,s2,788 # 1320 <malloc+0x208>
        for(; *s; s++)
    1014:	02800593          	li	a1,40
    1018:	b7c5                	j	ff8 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    101a:	8bce                	mv	s7,s3
      state = 0;
    101c:	4981                	li	s3,0
    101e:	bbf9                	j	dfc <vprintf+0x4a>
